...
class TestFlattenTileNdTo2DBatchMatmul:
    ...
    def test_batch_matmul_with_named_transpose_unrolls_per_batch(self):
        """Named transpose operands lower the same way as inline transpose operands."""
        ...
        class Before:
            ...
            def main_incore_0(
                ...
                lhs_t: pl.Tile[[2, 16, 128], pl.FP16] = pl.transpose(lhs_tile, axis1=1, axis2=2)
                rhs_t: pl.Tile[[2, 128, 64], pl.FP16] = pl.transpose(rhs_tile, axis1=1, axis2=2)
