    ...
    def test_simple_elementwise_add(self):
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                out: pl.Tensor[[64], pl.FP32] = pl.store(y_tile, [0], out_0)
                return out
    ...
    def test_two_tensor_inputs(self):
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                out: pl.Tensor[[64], pl.FP32] = pl.store(z_tile, [0], out_0)
                return out
    ...
    def test_2d_tensor(self):
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                out: pl.Tensor[[32, 64], pl.FP16] = pl.store(y_tile, [0, 0], out_0)
                return out
    ...
    def test_matmul_conversion(self):
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                out: pl.Tensor[[16, 64], pl.FP16] = pl.store(y_tile, [0, 0], out_0)
                return out
    ...
    def test_matmul_b_trans_conversion(self):
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                out: pl.Tensor[[16, 128], pl.BF16] = pl.store(y_tile, [0, 0], out_0)
                return out
    ...
    def test_assemble_tile_tile_then_cast_conversion(self):
        ...
        class Before:
            ...
            def main_incore_0(
                ...
                t0: pl.Tensor[[1, 64], pl.FP32] = pl.create_tensor([1, 64], dtype=pl.FP32)
                t1 = pl.assemble(t0, a, [0, 0])
                t2 = pl.assemble(t1, b, [0, 32])
                out: pl.Tensor[[1, 64], pl.BF16] = pl.cast(t2, target_type=pl.BF16)
                return out
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                if n == 0:
                    ...
                    z = pl.yield_(y_tile)
                out: pl.Tensor[[64], pl.FP32] = pl.store(z, [0], out_0)
                return out
    ...
    def test_gm_tensor_slice_to_tile_load(self):
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                out: pl.Tensor[[8, 32], pl.FP32] = pl.store(y_tile, [0, 0], out_0)
                return out
    ...
    def test_consecutive_slice_converts_to_tile_slice(self):
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                out: pl.Tensor[[4, 8], pl.FP32] = pl.store(s2_tile, [0, 0], out_0)
                return out
    ...
    def test_triple_consecutive_slice(self):
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                out: pl.Tensor[[2, 4], pl.FP32] = pl.store(s3_tile, [0, 0], out_0)
                return out
    ...
    def test_consecutive_slice_with_computation(self):
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                out: pl.Tensor[[4, 8], pl.FP32] = pl.store(y_tile, [0, 0], out_0)
                return out
    ...
    def test_slice_then_matmul_no_trans(self):
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                out: pl.Tensor[[16, 64], pl.BF16] = pl.store(result_tile, [0, 0], out_0)
                return out
    ...
    def test_slice_then_matmul_btrans(self):
        ...
        class Expected:
            ...
            def main_incore_0(
                ...
                out: pl.Tensor[[1, 120], pl.BF16] = pl.store(result_tile, [0, 0], out_0)
                return out
