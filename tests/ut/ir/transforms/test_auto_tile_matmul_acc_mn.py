...
def _jit_program(kernel):
    ...
    _, _, tensor_meta, scalar_dtypes, cx, per_func_dyn = kernel._bind_args_from_signature({})
    return kernel._compile_to_program(tensor_meta, scalar_dtypes, cx, per_func_dyn, pl)
