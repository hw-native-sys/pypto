...
NOTE: All ST tests are skipped because PTOAS does not yet have a real NPU
implementation for pto.mscatter — it falls back to TSTORE which ignores the
index tile entirely.  PyPTO-side IR generation is correct; enable these tests
once PTOAS ships a proper MSCATTER lowering.
"""
...
pytestmark = pytest.mark.skip(
    reason="PTOAS pto.mscatter has no NPU implementation yet (falls back to TSTORE, ignoring idx)"
)
