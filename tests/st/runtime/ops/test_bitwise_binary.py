...
_PL_SCALAR_DT = {
    DataType.INT8: pl.INT8,
    DataType.UINT8: pl.INT8,
    DataType.INT16: pl.INT16,
    DataType.UINT16: pl.INT16,
    DataType.INT32: pl.INT32,
    DataType.UINT32: pl.INT32,
}
...
def _make_program(
    ...
    scalar_dtype = _PL_SCALAR_DT[dtype]
    ...
    if op_name == "ands":
        ...
        class AndsSSAProgram:
            ...
            def kernel(
                ...
                scalar_value: pl.Scalar[scalar_dtype] = pl.cast(pl.read(lhs, [0, 2]), scalar_dtype)
                lhs_tile = pl.load(lhs, [0, 0], [M, N], valid_shape=valid)
