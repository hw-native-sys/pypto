...
builtin chip dispatch。它在 [`MaterializeCommDomainScopes`](40-materialize_comm_domain_scopes.md) 之后运行，
...
[`MaterializeCommDomainScopes`](40-materialize_comm_domain_scopes.md) 会提前
