...
**Pipeline 位置**：紧跟在 [`LegalizeTileCast`](17-legalize_tile_cast.md) 之后，先于 [`CanonicalizeTileSlice`](19-canonicalize_tile_slice.md) 与 [`InferTileMemorySpace`](21-infer_tile_memory_space.md)。此时 tile op 已是 2D，但 memory space 尚未推断。
...
见 [`31-canonicalize_io_order.md`](33-canonicalize_io_order.md)。
