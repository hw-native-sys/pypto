...
- The external research `DSA` planner also skips this pass. Its shared lifetime
  analysis exports the surviving pipeline membership as hard solver separations.
