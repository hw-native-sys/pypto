...
**Pipeline position**: After [`LegalizeTileCast`](17-legalize_tile_cast.md), before [`CanonicalizeTileSlice`](19-canonicalize_tile_slice.md) and [`InferTileMemorySpace`](21-infer_tile_memory_space.md). All tile ops are already 2D and memory spaces have not yet been inferred.
...
[`31-canonicalize_io_order.md`](33-canonicalize_io_order.md) for the co-live
