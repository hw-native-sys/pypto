...
[MemoryReuse](32-memory_reuse.md#declared-allocations) for why an author would want it.
...
[MemoryReuse](32-memory_reuse.md#declared-allocations). Tiles on *different* slots are
