...
[`MaterializeRuntimeScopes`](47-materialize_runtime_scopes.md) and immediately
before [`InsertCommFence`](49-insert_comm_fence.md). Running this late means the
...
- [MaterializeRuntimeScopes](47-materialize_runtime_scopes.md) — the pass that runs immediately before
