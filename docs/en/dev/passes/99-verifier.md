...
- **Structural Properties**: TypeChecked, BreakContinueValid, NoRedundantBlocks, UseAfterDef, and OutParamNotShadowed are verified at pipeline start by `PassPipeline` and before/after each pass by `VerificationInstrument`
...
| -------- | -------- | -------- |
| **Structural** | TypeChecked, BreakContinueValid, NoRedundantBlocks, UseAfterDef, OutParamNotShadowed | Always true. Verified at pipeline start and before/after each pass by `VerificationInstrument`. Never in PassProperties. |
...
| -------- | ------- | ----------- |
| `GetStructuralProperties()` | `{TypeChecked, BreakContinueValid, NoRedundantBlocks, UseAfterDef, OutParamNotShadowed}` | Invariants verified at pipeline start and before/after each pass |
