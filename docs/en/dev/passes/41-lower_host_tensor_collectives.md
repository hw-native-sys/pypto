...
after [`MaterializeCommDomainScopes`](40-materialize_comm_domain_scopes.md), so
...
`for`/`while` loop in `host_orch` — [`MaterializeCommDomainScopes`](40-materialize_comm_domain_scopes.md),
