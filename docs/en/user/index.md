...
| ----- | ---------------- |
| Mixed kernels (AIC + AIV in one function) | [LowerAutoVectorSplit](../dev/passes/23-lower_auto_vector_split.md), [ExpandMixedKernel](../dev/passes/25-expand_mixed_kernel.md), [TPUSH/TPOP](../reference/pto-isa/01-tpush_tpop.md) |
