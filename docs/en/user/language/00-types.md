...
See [FP4](../../dev/fp4.md) for PackFp4, cast samples, units, and
...
reverse FP8×FP4 form are not supported. Physical K, valid K, and scale groups use the post-cast
FP8 tile, not the packed x2 carrier. See [FP4](../../dev/fp4.md). Standalone `pl.quant_mx` (MXFP8-only in this release, with
