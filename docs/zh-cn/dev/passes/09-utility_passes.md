...
**测试**：`tests/ut/ir/transforms/test_normalize_stmt_structure.py`
...
**测试**：`tests/ut/ir/transforms/test_flatten_single_stmt.py`
...
**文件**：`src/ir/transforms/ir_verifier.cpp`
**规则名称**：`"NestedCallVerify"`
