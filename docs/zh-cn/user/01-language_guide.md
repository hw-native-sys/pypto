...
14. **MaterializeSemanticAliases** —— 保留语义强制共享的缓冲区
15. **MaterializeInplaceAliases** —— 编码安全的 PTOAS 操作边界别名
16. **MemoryReuse** —— 在 PYPTO 下共享生命周期不重叠的缓冲区
17. **AllocateMemoryAddr** —— 在 PYPTO 下分配具体内存地址
