...
class CompiledProgram:
    ...
    **Return** (program has a return value)::
    ...
    def has_return(self) -> bool:
        ...
        _, _, ret_types = self._get_metadata()
        return len(ret_types) > 0
    ...
    def __call__(
        ...
        **in-place** style, pass all tensors (including outputs) and the
        ...
        Raises:
            ...
            RuntimeError: If ``SIMPLER_ROOT`` is not set.
        """
        ...
        elif has_return and len(args) == n_inputs:
        ...
        # Return outputs for return-style calls
        if has_return and len(args) == n_inputs:
