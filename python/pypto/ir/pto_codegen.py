...
def generate(
    ...
    PTO backend. Kernel InCore functions go through the ptoas pipeline; the
    orchestration function reuses the shared orchestration codegen.

    Args:
        transformed_program: Program after pass pipeline
        output_dir: Base output directory (used for ptoas intermediates)
