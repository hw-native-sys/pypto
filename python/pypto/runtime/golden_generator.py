...
if TYPE_CHECKING:
    from pypto.runtime.harness import PTOTestCase, TensorSpec
...
class GoldenGenerator:
    ...
    - generate_inputs(params): Creates list of (name, value) tuples for tensors and scalars
    ...
    def generate(self, test_case: "PTOTestCase") -> str:
        ...
        lines = [
            ...
            "",
            "Generated by pypto.runtime.GoldenGenerator",
            '"""',
            "",
            "import ctypes",
            "import struct",
        ...
        lines.append('    """Generate inputs as list of (name, value) tuples."""')

        # First, create tensor variables
        ...
        # Add tensor tuples (reference variables)
        for spec in tensor_specs:
            lines.append(f'        ("{spec.name}", {spec.name}),')

        # Add scalar tuples (byte sizes using .nbytes)
        for spec in tensor_specs:
    ...
    def _dtype_to_torch_str(self, dtype) -> str:
        ...
        from pypto.runtime.harness import DataType  # noqa: PLC0415
    ...
    def _generate_compute_golden(self, test_case: "PTOTestCase") -> str:
        ...
        try:
            ...
            output_specs = [t for t in test_case.tensor_specs if t.is_output]
            lines = [
                "def compute_golden(tensors, params):",
