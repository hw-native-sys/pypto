...
def flatten_to_stmts(stmt: Stmt) -> list[Stmt]:
    ...
    Returns children of SeqStmts/OpStmts, or a single-element list.
    """

def wrap_in_seq_stmts(stmts: list[Stmt], span: Span) -> Stmt:
    """Wrap a list of statements into a single SeqStmts node."""
