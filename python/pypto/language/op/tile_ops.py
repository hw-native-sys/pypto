...
def _unwrap_tile_binary_rhs(rhs: Tile | int | float | Scalar) -> int | float | Expr:
    """Unwrap tile/scalar rhs into the IR-layer representation."""
...
def add(lhs: Tile, rhs: Tile | int | float | Scalar) -> Tile:
    ...
    """
    call_expr = _ir_ops.add(lhs.unwrap(), _unwrap_tile_binary_rhs(rhs))
    return Tile(expr=call_expr)
...
def sub(lhs: Tile, rhs: Tile | int | float | Scalar) -> Tile:
    ...
    """
    call_expr = _ir_ops.sub(lhs.unwrap(), _unwrap_tile_binary_rhs(rhs))
    return Tile(expr=call_expr)
...
def mul(lhs: Tile, rhs: Tile | int | float | Scalar) -> Tile:
    ...
    """
    call_expr = _ir_ops.mul(lhs.unwrap(), _unwrap_tile_binary_rhs(rhs))
    return Tile(expr=call_expr)
...
def div(lhs: Tile, rhs: Tile | int | float | Scalar) -> Tile:
    ...
    """
    call_expr = _ir_ops.div(lhs.unwrap(), _unwrap_tile_binary_rhs(rhs))
    return Tile(expr=call_expr)
...
def adds(lhs: Tile, rhs: int | float | Expr | Scalar) -> Tile:
    ...
    """
    call_expr = _ir_ops.adds(lhs.unwrap(), _unwrap_scalar_rhs(rhs))
    return Tile(expr=call_expr)
...
def subs(lhs: Tile, rhs: int | float | Expr | Scalar) -> Tile:
    ...
    """
    call_expr = _ir_ops.subs(lhs.unwrap(), _unwrap_scalar_rhs(rhs))
    return Tile(expr=call_expr)
...
def muls(lhs: Tile, rhs: int | float | Expr | Scalar) -> Tile:
    ...
    """
    call_expr = _ir_ops.muls(lhs.unwrap(), _unwrap_scalar_rhs(rhs))
    return Tile(expr=call_expr)
...
def divs(lhs: Tile, rhs: int | float | Expr | Scalar) -> Tile:
    ...
    """
    call_expr = _ir_ops.divs(lhs.unwrap(), _unwrap_scalar_rhs(rhs))
    return Tile(expr=call_expr)
