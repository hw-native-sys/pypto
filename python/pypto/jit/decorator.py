...
Public API
----------
    # Style A — single function with pl.incore() scope
    @pl.jit
...
class JITFunction:
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        """Specialize, compile (or serve from cache), and return ir.Program.
        ...
        Returns:
            ir.Program compiled for this specific shape/dtype combination.
        """
    ...
    def _compile(
        ...
        """Specialize entry + deps into @pl.program source, parse, and return ir.Program."""
