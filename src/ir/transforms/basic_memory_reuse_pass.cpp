...
/**
 * @brief BasicMemoryReuse pass implementation
 *
 ...
 */
class BasicMemoryReuse : public PassImpl {
 public:
  BasicMemoryReuse() = default;
  ~BasicMemoryReuse() override = default;

  ProgramPtr operator()(const ProgramPtr& program) override {
    INTERNAL_CHECK(program) << "BasicMemoryReuse pass cannot run on null program";
  ...
  [[nodiscard]] std::string GetName() const override { return "BasicMemoryReuse"; }
...
namespace pass {
Pass BasicMemoryReuse() { return Pass(std::make_shared<pypto::ir::BasicMemoryReuse>()); }
}  // namespace pass
}  // namespace ir
}  // namespace pypto
