...
REGISTER_OP("tile.sel")
    ...
    .add_argument("tmp", "Scratch tile required by TSEL (canonical TileType UINT32 [1, 8])")
    .set_input_memory(0, MemorySpace::Vec)
    .set_input_memory(1, MemorySpace::Vec)
    .set_input_memory(2, MemorySpace::Vec)
...
REGISTER_OP("tile.sels")
    ...
    .add_argument("tmp",
                  "Scratch tile required by TSELS; on A2/A3 it must hold at least one full physical src row")
