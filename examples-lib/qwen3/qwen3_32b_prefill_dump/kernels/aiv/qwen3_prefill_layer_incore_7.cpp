// Kernel Function: qwen3_prefill_layer_incore_7
...
static __aicore__ void qwen3_prefill_layer_incore_7(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3) {
  unsigned v4 = 20480;
  unsigned v5 = 5120;
  unsigned v6 = 256;
  unsigned v7 = 4;
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    __gm__ TensorData* resid1_tile__co_l0_rv_v1_tensor = reinterpret_cast<__gm__ TensorData*>(args[0]);
    ...
    // Unpack tensor: sq_sum__ssa_v5
    __gm__ TensorData* sq_sum__ssa_v5_tensor = reinterpret_cast<__gm__ TensorData*>(args[1]);
    __gm__ float* sq_sum__ssa_v5 = reinterpret_cast<__gm__ float*>(sq_sum__ssa_v5_tensor->buffer.addr) + sq_sum__ssa_v5_tensor->start_offset;
    ...
    qwen3_prefill_layer_incore_7(resid1_tile__co_l0_rv_v1, sq_sum__ssa_v5, ret0__out);
}
