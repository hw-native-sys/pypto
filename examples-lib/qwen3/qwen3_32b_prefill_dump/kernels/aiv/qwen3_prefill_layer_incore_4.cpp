// Kernel Function: qwen3_prefill_layer_incore_4
...
static __aicore__ void qwen3_prefill_layer_incore_4(__gm__ float* v1, __gm__ float* v2, __gm__ bfloat16_t* v3, __gm__ bfloat16_t* v4, __gm__ float* v5, __gm__ float* v6, __gm__ bfloat16_t* v7, __gm__ bfloat16_t* v8, int32_t v9, int32_t v10, int32_t v11, int32_t v12) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    __gm__ TensorData* cos_hi__ssa_v0_tensor = reinterpret_cast<__gm__ TensorData*>(args[0]);
    ...
    __gm__ TensorData* cos_lo__ssa_v0_tensor = reinterpret_cast<__gm__ TensorData*>(args[1]);
    ...
    // Unpack tensor: k_cache__co_l0_iter_v7
    __gm__ TensorData* k_cache__co_l0_iter_v7_tensor = reinterpret_cast<__gm__ TensorData*>(args[2]);
    __gm__ bfloat16_t* k_cache__co_l0_iter_v7 = reinterpret_cast<__gm__ bfloat16_t*>(k_cache__co_l0_iter_v7_tensor->buffer.addr) + k_cache__co_l0_iter_v7_tensor->start_offset;

    // Unpack tensor: k_proj_tile__co_l0_rv_v1
    __gm__ TensorData* k_proj_tile__co_l0_rv_v1_tensor = reinterpret_cast<__gm__ TensorData*>(args[3]);
    __gm__ bfloat16_t* k_proj_tile__co_l0_rv_v1 = reinterpret_cast<__gm__ bfloat16_t*>(k_proj_tile__co_l0_rv_v1_tensor->buffer.addr) + k_proj_tile__co_l0_rv_v1_tensor->start_offset;

    // Unpack tensor: sin_hi__ssa_v0
    __gm__ TensorData* sin_hi__ssa_v0_tensor = reinterpret_cast<__gm__ TensorData*>(args[4]);
    ...
    __gm__ TensorData* sin_lo__ssa_v0_tensor = reinterpret_cast<__gm__ TensorData*>(args[5]);
    ...
    // Unpack tensor: v_cache__co_l0_iter_v7
    __gm__ TensorData* v_cache__co_l0_iter_v7_tensor = reinterpret_cast<__gm__ TensorData*>(args[6]);
    __gm__ bfloat16_t* v_cache__co_l0_iter_v7 = reinterpret_cast<__gm__ bfloat16_t*>(v_cache__co_l0_iter_v7_tensor->buffer.addr) + v_cache__co_l0_iter_v7_tensor->start_offset;

    // Unpack tensor: v_proj_tile__co_l0_rv_v1
    __gm__ TensorData* v_proj_tile__co_l0_rv_v1_tensor = reinterpret_cast<__gm__ TensorData*>(args[7]);
    __gm__ bfloat16_t* v_proj_tile__co_l0_rv_v1 = reinterpret_cast<__gm__ bfloat16_t*>(v_proj_tile__co_l0_rv_v1_tensor->buffer.addr) + v_proj_tile__co_l0_rv_v1_tensor->start_offset;
    ...
    // Unpack scalar: kvh__co_idx_v0
    union { uint64_t u64; int64_t val; } kvh__co_idx_v0_conv;
    kvh__co_idx_v0_conv.u64 = args[9];
    int64_t kvh__co_idx_v0 = kvh__co_idx_v0_conv.val;

    // Unpack scalar: pos__ssa_v0
    union { uint64_t u64; int64_t val; } pos__ssa_v0_conv;
    pos__ssa_v0_conv.u64 = args[10];
    int64_t pos__ssa_v0 = pos__ssa_v0_conv.val;

    // Unpack scalar: ti__idx_v0
    union { uint64_t u64; int64_t val; } ti__idx_v0_conv;
    ti__idx_v0_conv.u64 = args[11];
    int64_t ti__idx_v0 = ti__idx_v0_conv.val;

    // Forward to ptoas-generated function
    qwen3_prefill_layer_incore_4(cos_hi__ssa_v0, cos_lo__ssa_v0, k_cache__co_l0_iter_v7, k_proj_tile__co_l0_rv_v1, sin_hi__ssa_v0, sin_lo__ssa_v0, v_cache__co_l0_iter_v7, v_proj_tile__co_l0_rv_v1, b__idx_v0, kvh__co_idx_v0, pos__ssa_v0, ti__idx_v0);
}
