// Kernel Function: qwen3_prefill_layer_incore_2_aiv
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    __gm__ TensorData* k_proj_tile__co_l0_iter_v1_tensor = reinterpret_cast<__gm__ TensorData*>(args[3]);
    __gm__ bfloat16_t* k_proj_tile__co_l0_iter_v1 = reinterpret_cast<__gm__ bfloat16_t*>(k_proj_tile__co_l0_iter_v1_tensor->buffer.addr) + k_proj_tile__co_l0_iter_v1_tensor->start_offset;

    // Unpack tensor: v_proj_tile__co_l0_iter_v1
    __gm__ TensorData* v_proj_tile__co_l0_iter_v1_tensor = reinterpret_cast<__gm__ TensorData*>(args[4]);
    __gm__ bfloat16_t* v_proj_tile__co_l0_iter_v1 = reinterpret_cast<__gm__ bfloat16_t*>(v_proj_tile__co_l0_iter_v1_tensor->buffer.addr) + v_proj_tile__co_l0_iter_v1_tensor->start_offset;

    // Unpack tensor: wk__ssa_v0
    __gm__ TensorData* wk__ssa_v0_tensor = reinterpret_cast<__gm__ TensorData*>(args[5]);
    ...
    __gm__ TensorData* wv__ssa_v0_tensor = reinterpret_cast<__gm__ TensorData*>(args[6]);
    ...
    valid_tok__ssa_v0_conv.u64 = args[10];
    int64_t valid_tok__ssa_v0 = valid_tok__ssa_v0_conv.val;

    // Forward to ptoas-generated function
    qwen3_prefill_layer_incore_2_aiv(hidden_states__ssa_v0, input_rms_weight__ssa_v0, inv_rms__ssa_v0, k_proj_tile__co_l0_iter_v1, v_proj_tile__co_l0_iter_v1, wk__ssa_v0, wv__ssa_v0, b__idx_v0, ob__co_idx_v0, p0__ssa_v0, valid_tok__ssa_v0);
}
