...
class Qwen3SingleLayerPrefill:
    ...
    def qwen3_prefill_layer_incore_0(self, b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], p0__ssa_v0: pl.Scalar[pl.INDEX], sq_sum__ssa_v0: pl.Tensor[[4, 1], pl.FP32], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], ret0__out: pl.Out[pl.Tensor[[4, 1], pl.FP32]]) -> pl.Tensor[[4, 1], pl.FP32]:
        ...
        sq_sum__rm_a0_tmp_v0: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(sq_sum__tile, [1, 4])
        sq_sum__row_major_tmp_v1: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.muls(sq_sum__rm_a0_tmp_v0, 0.0)
        sq_sum__tile_1: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(sq_sum__row_major_tmp_v1, [4, 1])
        for kb__idx_v0, (sq_sum__iter_v2,) in pl.range(20, init_values=(sq_sum__tile_1,)):
            k0__ssa_v0: pl.Scalar[pl.INDEX] = kb__idx_v0 * 256
            t__tile: pl.Tile[[4, 256], pl.BF16, pl.Mem.Vec] = pl.tile.load(hidden_states__ssa_v0, [b__idx_v0, p0__ssa_v0, k0__ssa_v0], [1, 4, 256], [1, valid_tok__ssa_v0, 256], target_memory=pl.Mem.Vec, transpose=False)
            t__tile_1: pl.Tile[[4, 256], pl.FP32, pl.Mem.Vec] = pl.tile.cast(t__tile, target_type=pl.FP32, mode='round')
            ...
            sq_sum__rm_a0_tmp_v2: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(sq_sum__iter_v2, [1, 4])
            sq_sum__rm_a1_tmp_v3: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_3, [1, 4])
            sq_sum__row_major_tmp_v4: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.add(sq_sum__rm_a0_tmp_v2, sq_sum__rm_a1_tmp_v3)
            sq_sum__tile_2: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(sq_sum__row_major_tmp_v4, [4, 1])
            sq_sum__rv_v3: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.yield_(sq_sum__tile_2)
        t__rm_a0_tmp_v5: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(sq_sum__rv_v3, [1, 4])
        t__row_major_tmp_v6: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.muls(t__rm_a0_tmp_v5, 0.000195313)
        t__tile_4: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(t__row_major_tmp_v6, [4, 1])
        t__rm_a0_tmp_v7: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_4, [1, 4])
        t__row_major_tmp_v8: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.adds(t__rm_a0_tmp_v7, 1e-06)
        t__tile_5: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(t__row_major_tmp_v8, [4, 1])
        inv_rms__rm_a0_tmp_v9: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_5, [1, 4])
        inv_rms__row_major_tmp_v10: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.rsqrt(inv_rms__rm_a0_tmp_v9)
        inv_rms__tile: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(inv_rms__row_major_tmp_v10, [4, 1])
        ret0__store: pl.Tensor[[4, 1], pl.FP32] = pl.tile.store(inv_rms__tile, [0, 0], ret0__out)
        return ret0__store
    @pl.function(type=pl.FunctionType.AIC)
    def qwen3_prefill_layer_incore_1_aic(self, b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], input_rms_weight__ssa_v0: pl.Tensor[[1, 5120], pl.FP32], inv_rms__ssa_v0: pl.Tensor[[4, 1], pl.FP32], ob__co_idx_v0: pl.Scalar[pl.INDEX], p0__ssa_v0: pl.Scalar[pl.INDEX], q_proj_tile__co_l0_iter_v1: pl.Out[pl.Tensor[[4, 5120], pl.BF16]], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], wq__ssa_v0: pl.Tensor[[5120, 5120], pl.BF16]):
        qwen3_prefill_layer_incore_1_v2c_slot_buffer: pl.UnknownType = pl.system.reserve_buffer(name='qwen3_prefill_layer_incore_1_v2c_slot_buffer', size=8192, base=-1)
        ...
        for ob__ci_idx_v0 in pl.parallel(8):
            ...
            for kb__idx_v0 in pl.range(20):
                ...
                wq_chunk__tile_Right: pl.Tile[[256, 64], pl.BF16, pl.Mem.Right, pl.TileView(slayout=pl.TileLayout.col_major)] = pl.tile.move(wq_chunk__tile, target_memory=pl.Mem.Right)
                t__tile_Left_mat: pl.Tile[[4, 256], pl.BF16, pl.Mem.Mat] = pl.tile.tpop_from_aiv(split=0)
                t__tile_Left: pl.Tile[[4, 256], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(t__tile_Left_mat, target_memory=pl.Mem.Left)
                pl.system.tfree_to_aiv(t__tile_Left_mat)
                t__tile: pl.Tile[[4, 64], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(t__tile_Left, wq_chunk__tile_Right)
                pl.tile.tpush_to_aiv(t__tile, split=0)
    @pl.function(type=pl.FunctionType.AIV)
    def qwen3_prefill_layer_incore_1_aiv(self, b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], input_rms_weight__ssa_v0: pl.Tensor[[1, 5120], pl.FP32], inv_rms__ssa_v0: pl.Tensor[[4, 1], pl.FP32], ob__co_idx_v0: pl.Scalar[pl.INDEX], p0__ssa_v0: pl.Scalar[pl.INDEX], q_proj_tile__co_l0_iter_v1: pl.Out[pl.Tensor[[4, 5120], pl.BF16]], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], wq__ssa_v0: pl.Tensor[[5120, 5120], pl.BF16]) -> pl.Tensor[[4, 5120], pl.BF16]:
        ...
        qwen3_prefill_layer_incore_1_c2v_slot_buffer: pl.UnknownType = pl.system.reserve_buffer(name='qwen3_prefill_layer_incore_1_c2v_slot_buffer', size=8192, base=-1)
        ...
        for ob__ci_idx_v0, (q_proj_tile__co_l1_iter_v1,) in pl.parallel(8, init_values=(q_proj_tile__co_l0_iter_v1,)):
            ...
            for kb__idx_v0, (q_acc__iter_v2,) in pl.range(20, init_values=(q_acc__tile_1,)):
                k0__ssa_v1: pl.Scalar[pl.INDEX] = kb__idx_v0 * 256
                t__tile: pl.Tile[[4, 256], pl.BF16, pl.Mem.Vec] = pl.tile.load(hidden_states__ssa_v0, [b__idx_v0, p0__ssa_v0, k0__ssa_v1], [1, 4, 256], [1, valid_tok__ssa_v0, 256], target_memory=pl.Mem.Vec, transpose=False)
                t__tile_1: pl.Tile[[4, 256], pl.FP32, pl.Mem.Vec] = pl.tile.cast(t__tile, target_type=pl.FP32, mode='round')
                x_chunk__tile: pl.Tile[[4, 256], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_1, [4, 256])
                ...
                t__tile_Vec: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.tpop_from_aic(split=0)
                q_acc__tile_2: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.add(q_acc__iter_v2, t__tile_Vec)
                pl.system.tfree_to_aic(t__tile_Vec)
                q_acc__rv_v3: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.yield_(q_acc__tile_2)
            t__tile_4: pl.Tile[[4, 64], pl.BF16, pl.Mem.Vec] = pl.tile.cast(q_acc__rv_v3, target_type=pl.BF16, mode='round')
            q_proj_tile__tile: pl.Tensor[[4, 5120], pl.BF16] = pl.tile.store(t__tile_4, [0, q0__ssa_v0], q_proj_tile__co_l1_iter_v1)
    ...
    def qwen3_prefill_layer_incore_1(self, b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], input_rms_weight__ssa_v0: pl.Tensor[[1, 5120], pl.FP32], inv_rms__ssa_v0: pl.Tensor[[4, 1], pl.FP32], ob__co_idx_v0: pl.Scalar[pl.INDEX], p0__ssa_v0: pl.Scalar[pl.INDEX], q_proj_tile__co_l0_iter_v1: pl.Out[pl.Tensor[[4, 5120], pl.BF16]], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], wq__ssa_v0: pl.Tensor[[5120, 5120], pl.BF16]) -> pl.Tensor[[4, 5120], pl.BF16]:
        ...
        result: pl.Tensor[[4, 5120], pl.BF16] = self.qwen3_prefill_layer_incore_1_aiv(b__idx_v0, hidden_states__ssa_v0, input_rms_weight__ssa_v0, inv_rms__ssa_v0, ob__co_idx_v0, p0__ssa_v0, q_proj_tile__co_l0_iter_v1, valid_tok__ssa_v0, wq__ssa_v0)
        return result
    @pl.function(type=pl.FunctionType.AIC)
    def qwen3_prefill_layer_incore_10_aic(self, b__idx_v0: pl.Scalar[pl.INDEX], dob__co_idx_v0: pl.Scalar[pl.INDEX], down_proj_tile__co_l0_iter_v4: pl.InOut[pl.Tensor[[4, 5120], pl.FP32]], mlp_chunk_bf16__ssa_v0: pl.Tensor[[4, 64], pl.BF16], o0__ssa_v1: pl.Scalar[pl.INDEX], ob__idx_v0: pl.Scalar[pl.INDEX], out__co_l0_iter_v7: pl.Out[pl.Tensor[[16, 4096, 5120], pl.BF16]], p0__ssa_v0: pl.Scalar[pl.INDEX], resid1_tile__co_l0_rv_v1: pl.Tensor[[4, 5120], pl.FP32], w_down__ssa_v0: pl.Tensor[[25600, 5120], pl.BF16]):
        ...
        for dob__ci_idx_v0 in pl.parallel(8):
            ...
            w_down_chunk__tile_Right: pl.Tile[[64, 64], pl.BF16, pl.Mem.Right, pl.TileView(slayout=pl.TileLayout.col_major)] = pl.tile.move(w_down_chunk__tile, target_memory=pl.Mem.Right)
            ...
            lhs_mat_Left: pl.Tile[[4, 64], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(lhs_mat, target_memory=pl.Mem.Left)
            t__tile: pl.Tile[[4, 64], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(lhs_mat_Left, w_down_chunk__tile_Right)
            pl.tile.tpush_to_aiv(t__tile, split=0)
    @pl.function(type=pl.FunctionType.AIV)
    def qwen3_prefill_layer_incore_10_aiv(self, b__idx_v0: pl.Scalar[pl.INDEX], dob__co_idx_v0: pl.Scalar[pl.INDEX], down_proj_tile__co_l0_iter_v4: pl.InOut[pl.Tensor[[4, 5120], pl.FP32]], mlp_chunk_bf16__ssa_v0: pl.Tensor[[4, 64], pl.BF16], o0__ssa_v1: pl.Scalar[pl.INDEX], ob__idx_v0: pl.Scalar[pl.INDEX], out__co_l0_iter_v7: pl.Out[pl.Tensor[[16, 4096, 5120], pl.BF16]], p0__ssa_v0: pl.Scalar[pl.INDEX], resid1_tile__co_l0_rv_v1: pl.Tensor[[4, 5120], pl.FP32], w_down__ssa_v0: pl.Tensor[[25600, 5120], pl.BF16]) -> tuple[pl.Tensor[[4, 5120], pl.FP32], pl.Tensor[[16, 4096, 5120], pl.BF16]]:
        qwen3_prefill_layer_incore_10_c2v_slot_buffer: pl.UnknownType = pl.system.reserve_buffer(name='qwen3_prefill_layer_incore_10_c2v_slot_buffer', size=8192, base=-1)
        ...
        for dob__ci_idx_v0, (down_proj_tile__co_l1_iter_v4, out__co_l1_iter_v7) in pl.parallel(8, init_values=(down_proj_tile__co_l0_iter_v4, out__co_l0_iter_v7)):
            ...
            t__tile_Vec: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.tpop_from_aic(split=0)
            down_next__tile: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.add(down_prev__tile, t__tile_Vec)
            pl.system.tfree_to_aic(t__tile_Vec)
            down_proj_tile__tile: pl.Tensor[[4, 5120], pl.FP32] = pl.tile.store(down_next__tile, [0, d0__ssa_v0], down_proj_tile__co_l1_iter_v4)
            if ob__idx_v0 == 399:
                t__tile: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.load(down_proj_tile__tile, [0, d0__ssa_v0], [4, 64], [4, 64], target_memory=pl.Mem.Vec, transpose=False)
                t__tile_1: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.load(resid1_tile__co_l0_rv_v1, [0, d0__ssa_v0], [4, 64], [4, 64], target_memory=pl.Mem.Vec, transpose=False)
                down_acc__tile: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile, t__tile_1)
                t__tile_2: pl.Tile[[4, 64], pl.BF16, pl.Mem.Vec] = pl.tile.cast(down_acc__tile, target_type=pl.BF16, mode='round')
                out__tile: pl.Tensor[[16, 4096, 5120], pl.BF16] = pl.tile.store(t__tile_2, [b__idx_v0, p0__ssa_v0, d0__ssa_v0], out__co_l1_iter_v7, [1, 4, 64])
    ...
    def qwen3_prefill_layer_incore_10(self, b__idx_v0: pl.Scalar[pl.INDEX], dob__co_idx_v0: pl.Scalar[pl.INDEX], down_proj_tile__co_l0_iter_v4: pl.InOut[pl.Tensor[[4, 5120], pl.FP32]], mlp_chunk_bf16__ssa_v0: pl.Tensor[[4, 64], pl.BF16], o0__ssa_v1: pl.Scalar[pl.INDEX], ob__idx_v0: pl.Scalar[pl.INDEX], out__co_l0_iter_v7: pl.Out[pl.Tensor[[16, 4096, 5120], pl.BF16]], p0__ssa_v0: pl.Scalar[pl.INDEX], resid1_tile__co_l0_rv_v1: pl.Tensor[[4, 5120], pl.FP32], w_down__ssa_v0: pl.Tensor[[25600, 5120], pl.BF16]) -> tuple[pl.Tensor[[4, 5120], pl.FP32], pl.Tensor[[16, 4096, 5120], pl.BF16]]:
        ...
        return result
    @pl.function(type=pl.FunctionType.AIC)
    def qwen3_prefill_layer_incore_2_aic(self, b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], input_rms_weight__ssa_v0: pl.Tensor[[1, 5120], pl.FP32], inv_rms__ssa_v0: pl.Tensor[[4, 1], pl.FP32], k_proj_tile__co_l0_iter_v1: pl.Out[pl.Tensor[[4, 1024], pl.BF16]], ob__co_idx_v0: pl.Scalar[pl.INDEX], p0__ssa_v0: pl.Scalar[pl.INDEX], v_proj_tile__co_l0_iter_v1: pl.Out[pl.Tensor[[4, 1024], pl.BF16]], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], wk__ssa_v0: pl.Tensor[[5120, 1024], pl.BF16], wv__ssa_v0: pl.Tensor[[5120, 1024], pl.BF16]):
        qwen3_prefill_layer_incore_2_v2c_slot_buffer: pl.UnknownType = pl.system.reserve_buffer(name='qwen3_prefill_layer_incore_2_v2c_slot_buffer', size=8192, base=-1)
        ...
        for ob__ci_idx_v0 in pl.parallel(8):
            ...
            for kb__idx_v0 in pl.range(20):
                ...
                normed_bf16__tile_Left_mat: pl.Tile[[4, 256], pl.BF16, pl.Mem.Mat] = pl.tile.tpop_from_aiv(split=0)
                normed_bf16__tile_Left: pl.Tile[[4, 256], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(normed_bf16__tile_Left_mat, target_memory=pl.Mem.Left)
                ...
                wk_chunk__tile_Right: pl.Tile[[256, 32], pl.BF16, pl.Mem.Right, pl.TileView(slayout=pl.TileLayout.col_major)] = pl.tile.move(wk_chunk__tile, target_memory=pl.Mem.Right)
                ...
                wv_chunk__tile_Right: pl.Tile[[256, 32], pl.BF16, pl.Mem.Right, pl.TileView(slayout=pl.TileLayout.col_major)] = pl.tile.move(wv_chunk__tile, target_memory=pl.Mem.Right)
                t__tile: pl.Tile[[4, 32], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(normed_bf16__tile_Left, wk_chunk__tile_Right)
                pl.tile.tpush_to_aiv(t__tile, split=0)
                t__tile_1: pl.Tile[[4, 32], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(normed_bf16__tile_Left, wv_chunk__tile_Right)
                pl.tile.tpush_to_aiv(t__tile_1, split=0)
    @pl.function(type=pl.FunctionType.AIV)
    def qwen3_prefill_layer_incore_2_aiv(self, b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], input_rms_weight__ssa_v0: pl.Tensor[[1, 5120], pl.FP32], inv_rms__ssa_v0: pl.Tensor[[4, 1], pl.FP32], k_proj_tile__co_l0_iter_v1: pl.Out[pl.Tensor[[4, 1024], pl.BF16]], ob__co_idx_v0: pl.Scalar[pl.INDEX], p0__ssa_v0: pl.Scalar[pl.INDEX], v_proj_tile__co_l0_iter_v1: pl.Out[pl.Tensor[[4, 1024], pl.BF16]], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], wk__ssa_v0: pl.Tensor[[5120, 1024], pl.BF16], wv__ssa_v0: pl.Tensor[[5120, 1024], pl.BF16]) -> tuple[pl.Tensor[[4, 1024], pl.BF16], pl.Tensor[[4, 1024], pl.BF16]]:
        ...
        qwen3_prefill_layer_incore_2_c2v_slot_buffer: pl.UnknownType = pl.system.reserve_buffer(name='qwen3_prefill_layer_incore_2_c2v_slot_buffer', size=8192, base=-1)
        pl.system.aiv_initialize_pipe(dir_mask=3, slot_size=2048)
        inv_rms__tile: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.load(inv_rms__ssa_v0, [0, 0], [4, 1], [4, 1], target_memory=pl.Mem.Vec, transpose=False)
        for ob__ci_idx_v0, (k_proj_tile__co_l1_iter_v1, v_proj_tile__co_l1_iter_v1) in pl.parallel(8, init_values=(k_proj_tile__co_l0_iter_v1, v_proj_tile__co_l0_iter_v1)):
            ...
            for kb__idx_v0, (k_acc__iter_v2, v_acc__iter_v2) in pl.range(20, init_values=(k_acc__tile_1, v_acc__tile_1)):
                k0__ssa_v2: pl.Scalar[pl.INDEX] = kb__idx_v0 * 256
                t__tile: pl.Tile[[4, 256], pl.BF16, pl.Mem.Vec] = pl.tile.load(hidden_states__ssa_v0, [b__idx_v0, p0__ssa_v0, k0__ssa_v2], [1, 4, 256], [1, valid_tok__ssa_v0, 256], target_memory=pl.Mem.Vec, transpose=False)
                t__tile_1: pl.Tile[[4, 256], pl.FP32, pl.Mem.Vec] = pl.tile.cast(t__tile, target_type=pl.FP32, mode='round')
                x_chunk__tile: pl.Tile[[4, 256], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_1, [4, 256])
                ...
                t__tile_Vec: pl.Tile[[4, 32], pl.FP32, pl.Mem.Vec] = pl.tile.tpop_from_aic(split=0)
                k_acc__tile_2: pl.Tile[[4, 32], pl.FP32, pl.Mem.Vec] = pl.tile.add(k_acc__iter_v2, t__tile_Vec)
                pl.system.tfree_to_aic(t__tile_Vec)
                t__tile_Vec_1: pl.Tile[[4, 32], pl.FP32, pl.Mem.Vec] = pl.tile.tpop_from_aic(split=0)
                v_acc__tile_2: pl.Tile[[4, 32], pl.FP32, pl.Mem.Vec] = pl.tile.add(v_acc__iter_v2, t__tile_Vec_1)
                pl.system.tfree_to_aic(t__tile_Vec_1)
                k_acc__rv_v3, v_acc__rv_v3 = pl.yield_(k_acc__tile_2, v_acc__tile_2)
            t__tile_3: pl.Tile[[4, 32], pl.BF16, pl.Mem.Vec] = pl.tile.cast(k_acc__rv_v3, target_type=pl.BF16, mode='round')
            k_proj_tile__tile: pl.Tensor[[4, 1024], pl.BF16] = pl.tile.store(t__tile_3, [0, kv0__ssa_v0], k_proj_tile__co_l1_iter_v1)
            t__tile_4: pl.Tile[[4, 32], pl.BF16, pl.Mem.Vec] = pl.tile.cast(v_acc__rv_v3, target_type=pl.BF16, mode='round')
            v_proj_tile__tile: pl.Tensor[[4, 1024], pl.BF16] = pl.tile.store(t__tile_4, [0, kv0__ssa_v0], v_proj_tile__co_l1_iter_v1)
    ...
    @pl.function(type=pl.FunctionType.AIC)
    def qwen3_prefill_layer_incore_5_aic(self, attn_row__co_l0_iter_v2: pl.Out[pl.Tensor[[1, 5120], pl.FP32]], b__idx_v0: pl.Scalar[pl.INDEX], cos_hi__ssa_v0: pl.Tensor[[1, 64], pl.FP32], cos_lo__ssa_v0: pl.Tensor[[1, 64], pl.FP32], ctx_blocks__ssa_v0: pl.Scalar[pl.INDEX], ctx_len__ssa_v0: pl.Scalar[pl.INDEX], h__co_idx_v0: pl.Scalar[pl.INDEX], k_cache__co_l0_rv_v7: pl.Tensor[[128, 524288], pl.BF16, pl.TensorView(stride=[], layout=pl.TensorLayout.DN)], q_proj_tile__co_l0_rv_v1: pl.Tensor[[4, 5120], pl.BF16], sin_hi__ssa_v0: pl.Tensor[[1, 64], pl.FP32], sin_lo__ssa_v0: pl.Tensor[[1, 64], pl.FP32], ti__idx_v0: pl.Scalar[pl.INDEX], v_cache__co_l0_rv_v7: pl.Tensor[[524288, 128], pl.BF16]):
        qwen3_prefill_layer_incore_5_v2c_slot_buffer: pl.UnknownType = pl.system.reserve_buffer(name='qwen3_prefill_layer_incore_5_v2c_slot_buffer', size=2048, base=-1)
        ...
        for h__ci_idx_v0 in pl.parallel(8):
            ...
            q_rot_bf16__tile_Left_mat: pl.Tile[[1, 128], pl.BF16, pl.Mem.Mat] = pl.tile.tpop_from_aiv(split=0)
            q_rot_bf16__tile_Left: pl.Tile[[1, 128], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(q_rot_bf16__tile_Left_mat, target_memory=pl.Mem.Left)
            ...
            for sb__idx_v0 in pl.range(ctx_blocks__ssa_v0):
                ...
                k_tile__tile_Right: pl.Tile[[128, 120], pl.BF16, pl.Mem.Right, pl.TileView(valid_shape=[128, valid_len__ssa_v0], slayout=pl.TileLayout.col_major)] = pl.tile.move(k_tile__tile, target_memory=pl.Mem.Right)
                ...
                v_tile__tile_Right: pl.Tile[[120, 128], pl.BF16, pl.Mem.Right, pl.TileView(valid_shape=[valid_len__ssa_v0, 128], slayout=pl.TileLayout.col_major)] = pl.tile.move(v_tile__tile, target_memory=pl.Mem.Right)
                t__tile: pl.Tile[[1, 120], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(q_rot_bf16__tile_Left, k_tile__tile_Right)
                pl.tile.tpush_to_aiv(t__tile, split=0)
                t__tile_Left_mat: pl.Tile[[1, 120], pl.BF16, pl.Mem.Mat] = pl.tile.tpop_from_aiv(split=0)
                t__tile_Left: pl.Tile[[1, 120], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(t__tile_Left_mat, target_memory=pl.Mem.Left)
                pl.system.tfree_to_aiv(t__tile_Left_mat)
                oi_tmp__tile: pl.Tile[[1, 128], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(t__tile_Left, v_tile__tile_Right)
                pl.tile.tpush_to_aiv(oi_tmp__tile, split=0)
    @pl.function(type=pl.FunctionType.AIV)
    def qwen3_prefill_layer_incore_5_aiv(self, attn_row__co_l0_iter_v2: pl.Out[pl.Tensor[[1, 5120], pl.FP32]], b__idx_v0: pl.Scalar[pl.INDEX], cos_hi__ssa_v0: pl.Tensor[[1, 64], pl.FP32], cos_lo__ssa_v0: pl.Tensor[[1, 64], pl.FP32], ctx_blocks__ssa_v0: pl.Scalar[pl.INDEX], ctx_len__ssa_v0: pl.Scalar[pl.INDEX], h__co_idx_v0: pl.Scalar[pl.INDEX], k_cache__co_l0_rv_v7: pl.Tensor[[128, 524288], pl.BF16, pl.TensorView(stride=[], layout=pl.TensorLayout.DN)], q_proj_tile__co_l0_rv_v1: pl.Tensor[[4, 5120], pl.BF16], sin_hi__ssa_v0: pl.Tensor[[1, 64], pl.FP32], sin_lo__ssa_v0: pl.Tensor[[1, 64], pl.FP32], ti__idx_v0: pl.Scalar[pl.INDEX], v_cache__co_l0_rv_v7: pl.Tensor[[524288, 128], pl.BF16]) -> pl.Tensor[[1, 5120], pl.FP32]:
        ...
        qwen3_prefill_layer_incore_5_c2v_slot_buffer: pl.UnknownType = pl.system.reserve_buffer(name='qwen3_prefill_layer_incore_5_c2v_slot_buffer', size=2048, base=-1)
        ...
        for h__ci_idx_v0, (attn_row__co_l1_iter_v2,) in pl.parallel(8, init_values=(attn_row__co_l0_iter_v2,)):
            ...
            for sb__idx_v0, (li__iter_v2, mi__iter_v2, oi__iter_v2) in pl.range(ctx_blocks__ssa_v0, init_values=(li__tile_1, mi__tile_1, oi__tile_1)):
                s0__ssa_v0: pl.Scalar[pl.INDEX] = sb__idx_v0 * 120
                valid_len__ssa_v0: pl.Scalar[pl.INDEX] = pl.min(120, ctx_len__ssa_v0 - s0__ssa_v0)
                t__tile_Vec: pl.Tile[[1, 120], pl.FP32, pl.Mem.Vec] = pl.tile.tpop_from_aic(split=0)
                scores__tile: pl.Tile[[1, 120], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(t__tile_Vec, 0.0883883)
                pl.system.tfree_to_aic(t__tile_Vec)
                oi_tmp__tile_Vec: pl.Tile[[1, 128], pl.FP32, pl.Mem.Vec] = pl.tile.tpop_from_aic(split=0)
                if sb__idx_v0 == 0:
                    oi__ssa_v4: pl.Tile[[1, 128], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = oi_tmp__tile_Vec
                    ...
                    mi_new__rm_a1_tmp_v1: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(cur_mi__tile, [1, 1])
                    mi_new__tile: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.maximum(mi__iter_v2, mi_new__rm_a1_tmp_v1)
                    t__tile_7: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.sub(mi__iter_v2, mi_new__tile)
                    alpha__tile: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.exp(t__tile_7)
                    t__rm_a0_tmp_v2: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(cur_mi__tile, [1, 1])
                    t__row_major_tmp_v3: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.sub(t__rm_a0_tmp_v2, mi_new__tile)
                    t__tile_8: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(t__row_major_tmp_v3, [1, 1])
                    beta__rm_a0_tmp_v4: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_8, [1, 1])
                    beta__row_major_tmp_v5: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.exp(beta__rm_a0_tmp_v4)
                    beta__tile: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(beta__row_major_tmp_v5, [1, 1])
                    t__tile_9: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.mul(alpha__tile, li__iter_v2)
                    t__rm_a0_tmp_v6: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(beta__tile, [1, 1])
                    t__rm_a1_tmp_v7: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(cur_li__tile, [1, 1])
                    t__row_major_tmp_v8: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.mul(t__rm_a0_tmp_v6, t__rm_a1_tmp_v7)
                    t__tile_10: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(t__row_major_tmp_v8, [1, 1])
                    li__rm_a1_tmp_v9: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_10, [1, 1])
                    li__tile_2: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_9, li__rm_a1_tmp_v9)
                    t__tile_11: pl.Tile[[1, 128], pl.FP32, pl.Mem.Vec] = pl.tile.row_expand_mul(oi__iter_v2, alpha__tile)
                    t__tile_12: pl.Tile[[1, 128], pl.FP32, pl.Mem.Vec] = pl.tile.row_expand_mul(oi_tmp__tile_Vec, beta__tile)
                    oi__tile_2: pl.Tile[[1, 128], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_11, t__tile_12)
                ...
                scores_valid__rm_a0_tmp_v0: pl.Tile[[1, 120], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(scores__tile, [1, 120])
                scores_valid__tile: pl.Tile[[1, 120], pl.FP32, pl.Mem.Vec, pl.TileView(valid_shape=[1, valid_len__ssa_v0])] = pl.tile.slice(scores_valid__rm_a0_tmp_v0, [1, 120], [0, 0], [1, valid_len__ssa_v0])
                tmp_tile: pl.Tile[[1, 128], pl.FP32, pl.Mem.Vec] = pl.tile.create([1, 128], dtype=pl.FP32, target_memory=pl.Mem.Vec)
                t__tile_13: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.row_max(scores_valid__tile, tmp_tile)
                cur_mi__tile: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.cast(t__tile_13, target_type=pl.FP32, mode='round')
                t__tile_14: pl.Tile[[1, 120], pl.FP32, pl.Mem.Vec] = pl.tile.row_expand_sub(scores_valid__tile, cur_mi__tile)
                exp_scores__tile: pl.Tile[[1, 120], pl.FP32, pl.Mem.Vec] = pl.tile.exp(t__tile_14)
                tmp_tile_1: pl.Tile[[1, 128], pl.FP32, pl.Mem.Vec] = pl.tile.create([1, 128], dtype=pl.FP32, target_memory=pl.Mem.Vec)
                t__tile_15: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.row_sum(exp_scores__tile, tmp_tile_1)
                cur_li__tile: pl.Tile[[1, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.cast(t__tile_15, target_type=pl.FP32, mode='round')
                ...
                t__tile_16: pl.Tile[[1, 120], pl.BF16, pl.Mem.Vec] = pl.tile.cast(exp_pad__tile_2, target_type=pl.BF16, mode='round')
    ...
    def qwen3_prefill_layer_incore_5(self, attn_row__co_l0_iter_v2: pl.Out[pl.Tensor[[1, 5120], pl.FP32]], b__idx_v0: pl.Scalar[pl.INDEX], cos_hi__ssa_v0: pl.Tensor[[1, 64], pl.FP32], cos_lo__ssa_v0: pl.Tensor[[1, 64], pl.FP32], ctx_blocks__ssa_v0: pl.Scalar[pl.INDEX], ctx_len__ssa_v0: pl.Scalar[pl.INDEX], h__co_idx_v0: pl.Scalar[pl.INDEX], k_cache__co_l0_rv_v7: pl.Tensor[[128, 524288], pl.BF16, pl.TensorView(stride=[], layout=pl.TensorLayout.DN)], q_proj_tile__co_l0_rv_v1: pl.Tensor[[4, 5120], pl.BF16], sin_hi__ssa_v0: pl.Tensor[[1, 64], pl.FP32], sin_lo__ssa_v0: pl.Tensor[[1, 64], pl.FP32], ti__idx_v0: pl.Scalar[pl.INDEX], v_cache__co_l0_rv_v7: pl.Tensor[[524288, 128], pl.BF16]) -> pl.Tensor[[1, 5120], pl.FP32]:
        ...
        result: pl.Tensor[[1, 5120], pl.FP32] = self.qwen3_prefill_layer_incore_5_aiv(attn_row__co_l0_iter_v2, b__idx_v0, cos_hi__ssa_v0, cos_lo__ssa_v0, ctx_blocks__ssa_v0, ctx_len__ssa_v0, h__co_idx_v0, k_cache__co_l0_rv_v7, q_proj_tile__co_l0_rv_v1, sin_hi__ssa_v0, sin_lo__ssa_v0, ti__idx_v0, v_cache__co_l0_rv_v7)
        return result
    @pl.function(type=pl.FunctionType.AIC)
    def qwen3_prefill_layer_incore_6_aic(self, attn_tile__rv_v3: pl.Tensor[[4, 5120], pl.FP32], b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], ob__co_idx_v0: pl.Scalar[pl.INDEX], p0__ssa_v0: pl.Scalar[pl.INDEX], resid1_tile__co_l0_iter_v1: pl.Out[pl.Tensor[[4, 5120], pl.FP32]], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], wo__ssa_v0: pl.Tensor[[5120, 5120], pl.BF16]):
        qwen3_prefill_layer_incore_6_v2c_slot_buffer: pl.UnknownType = pl.system.reserve_buffer(name='qwen3_prefill_layer_incore_6_v2c_slot_buffer', size=8192, base=-1)
        ...
        for ob__ci_idx_v0 in pl.parallel(8):
            ...
            for kb__idx_v0 in pl.range(20):
                ...
                a_chunk__tile_Left_mat: pl.Tile[[4, 256], pl.BF16, pl.Mem.Mat] = pl.tile.tpop_from_aiv(split=0)
                a_chunk__tile_Left: pl.Tile[[4, 256], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(a_chunk__tile_Left_mat, target_memory=pl.Mem.Left)
                ...
                w_chunk__tile_Right: pl.Tile[[256, 64], pl.BF16, pl.Mem.Right, pl.TileView(slayout=pl.TileLayout.col_major)] = pl.tile.move(w_chunk__tile, target_memory=pl.Mem.Right)
                t__tile: pl.Tile[[4, 64], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(a_chunk__tile_Left, w_chunk__tile_Right)
                pl.tile.tpush_to_aiv(t__tile, split=0)
    @pl.function(type=pl.FunctionType.AIV)
    def qwen3_prefill_layer_incore_6_aiv(self, attn_tile__rv_v3: pl.Tensor[[4, 5120], pl.FP32], b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], ob__co_idx_v0: pl.Scalar[pl.INDEX], p0__ssa_v0: pl.Scalar[pl.INDEX], resid1_tile__co_l0_iter_v1: pl.Out[pl.Tensor[[4, 5120], pl.FP32]], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], wo__ssa_v0: pl.Tensor[[5120, 5120], pl.BF16]) -> pl.Tensor[[4, 5120], pl.FP32]:
        ...
        qwen3_prefill_layer_incore_6_c2v_slot_buffer: pl.UnknownType = pl.system.reserve_buffer(name='qwen3_prefill_layer_incore_6_c2v_slot_buffer', size=8192, base=-1)
        pl.system.aiv_initialize_pipe(dir_mask=3, slot_size=2048)
        for ob__ci_idx_v0, (resid1_tile__co_l1_iter_v1,) in pl.parallel(8, init_values=(resid1_tile__co_l0_iter_v1,)):
            ...
            for kb__idx_v0, (o_acc__iter_v2,) in pl.range(20, init_values=(o_acc__tile_1,)):
                ...
                t__tile_Vec: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.tpop_from_aic(split=0)
                o_acc__tile_2: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.add(o_acc__iter_v2, t__tile_Vec)
                pl.system.tfree_to_aic(t__tile_Vec)
                o_acc__rv_v3: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.yield_(o_acc__tile_2)
            t__tile_1: pl.Tile[[4, 64], pl.BF16, pl.Mem.Vec] = pl.tile.load(hidden_states__ssa_v0, [b__idx_v0, p0__ssa_v0, o0__ssa_v0], [1, 4, 64], [1, valid_tok__ssa_v0, 64], target_memory=pl.Mem.Vec, transpose=False)
            t__tile_2: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.cast(t__tile_1, target_type=pl.FP32, mode='round')
            resid__tile: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_2, [4, 64])
            t__tile_3: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.add(o_acc__rv_v3, resid__tile)
            resid1_tile__tile: pl.Tensor[[4, 5120], pl.FP32] = pl.tile.store(t__tile_3, [0, o0__ssa_v0], resid1_tile__co_l1_iter_v1)
    ...
    def qwen3_prefill_layer_incore_6(self, attn_tile__rv_v3: pl.Tensor[[4, 5120], pl.FP32], b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], ob__co_idx_v0: pl.Scalar[pl.INDEX], p0__ssa_v0: pl.Scalar[pl.INDEX], resid1_tile__co_l0_iter_v1: pl.Out[pl.Tensor[[4, 5120], pl.FP32]], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], wo__ssa_v0: pl.Tensor[[5120, 5120], pl.BF16]) -> pl.Tensor[[4, 5120], pl.FP32]:
        ...
        result: pl.Tensor[[4, 5120], pl.FP32] = self.qwen3_prefill_layer_incore_6_aiv(attn_tile__rv_v3, b__idx_v0, hidden_states__ssa_v0, ob__co_idx_v0, p0__ssa_v0, resid1_tile__co_l0_iter_v1, valid_tok__ssa_v0, wo__ssa_v0)
        return result
    @pl.function(type=pl.FunctionType.AIV)
    def qwen3_prefill_layer_incore_7(self, resid1_tile__co_l0_rv_v1: pl.Tensor[[4, 5120], pl.FP32], sq_sum__ssa_v5: pl.Tensor[[4, 1], pl.FP32], ret0__out: pl.Out[pl.Tensor[[4, 1], pl.FP32]]) -> pl.Tensor[[4, 1], pl.FP32]:
        ...
        for kb__idx_v0, (sq_sum__iter_v7,) in pl.range(20, init_values=(sq_sum__tile_1,)):
            ...
            sq_sum__rm_a0_tmp_v2: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(sq_sum__iter_v7, [1, 4])
            sq_sum__rm_a1_tmp_v3: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_1, [1, 4])
            sq_sum__row_major_tmp_v4: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.add(sq_sum__rm_a0_tmp_v2, sq_sum__rm_a1_tmp_v3)
            sq_sum__tile_2: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(sq_sum__row_major_tmp_v4, [4, 1])
            sq_sum__rv_v8: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.yield_(sq_sum__tile_2)
        t__rm_a0_tmp_v5: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(sq_sum__rv_v8, [1, 4])
        t__row_major_tmp_v6: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.muls(t__rm_a0_tmp_v5, 0.000195313)
        t__tile_2: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(t__row_major_tmp_v6, [4, 1])
        t__rm_a0_tmp_v7: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_2, [1, 4])
        t__row_major_tmp_v8: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.adds(t__rm_a0_tmp_v7, 1e-06)
        t__tile_3: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(t__row_major_tmp_v8, [4, 1])
        inv_rms__rm_a0_tmp_v9: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_3, [1, 4])
        inv_rms__row_major_tmp_v10: pl.Tile[[1, 4], pl.FP32, pl.Mem.Vec] = pl.tile.rsqrt(inv_rms__rm_a0_tmp_v9)
        inv_rms__tile: pl.Tile[[4, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(inv_rms__row_major_tmp_v10, [4, 1])
        ret0__store: pl.Tensor[[4, 1], pl.FP32] = pl.tile.store(inv_rms__tile, [0, 0], ret0__out)
        return ret0__store
    ...
    @pl.function(type=pl.FunctionType.AIC)
    def qwen3_prefill_layer_incore_9_aic(self, gate_acc__ssa_v0: pl.Tensor[[4, 64], pl.FP32], o0__ssa_v1: pl.Scalar[pl.INDEX], post_norm_tile__rv_v2: pl.Tensor[[4, 5120], pl.BF16], up_acc__ssa_v0: pl.Tensor[[4, 64], pl.FP32], w_gate__ssa_v0: pl.Tensor[[5120, 25600], pl.BF16], w_up__ssa_v0: pl.Tensor[[5120, 25600], pl.BF16], ret0__out: pl.Out[pl.Tensor[[4, 64], pl.BF16]]):
        ...
        for kb__idx_v0 in pl.range(20):
            ...
            post_chunk__tile_Left: pl.Tile[[4, 256], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(post_chunk__tile, target_memory=pl.Mem.Left)
            ...
            wg__tile_Right: pl.Tile[[256, 64], pl.BF16, pl.Mem.Right, pl.TileView(slayout=pl.TileLayout.col_major)] = pl.tile.move(wg__tile, target_memory=pl.Mem.Right)
            ...
            wu__tile_Right: pl.Tile[[256, 64], pl.BF16, pl.Mem.Right, pl.TileView(slayout=pl.TileLayout.col_major)] = pl.tile.move(wu__tile, target_memory=pl.Mem.Right)
            t__tile: pl.Tile[[4, 64], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(post_chunk__tile_Left, wg__tile_Right)
            pl.tile.tpush_to_aiv(t__tile, split=0)
            t__tile_1: pl.Tile[[4, 64], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(post_chunk__tile_Left, wu__tile_Right)
            pl.tile.tpush_to_aiv(t__tile_1, split=0)
    @pl.function(type=pl.FunctionType.AIV)
    def qwen3_prefill_layer_incore_9_aiv(self, gate_acc__ssa_v0: pl.Tensor[[4, 64], pl.FP32], o0__ssa_v1: pl.Scalar[pl.INDEX], post_norm_tile__rv_v2: pl.Tensor[[4, 5120], pl.BF16], up_acc__ssa_v0: pl.Tensor[[4, 64], pl.FP32], w_gate__ssa_v0: pl.Tensor[[5120, 25600], pl.BF16], w_up__ssa_v0: pl.Tensor[[5120, 25600], pl.BF16], ret0__out: pl.Out[pl.Tensor[[4, 64], pl.BF16]]) -> pl.Tensor[[4, 64], pl.BF16]:
        qwen3_prefill_layer_incore_9_c2v_slot_buffer: pl.UnknownType = pl.system.reserve_buffer(name='qwen3_prefill_layer_incore_9_c2v_slot_buffer', size=8192, base=-1)
        pl.system.aiv_initialize_pipe(dir_mask=1, slot_size=1024)
        ...
        for kb__idx_v0, (gate_acc__iter_v2, up_acc__iter_v2) in pl.range(20, init_values=(gate_acc__tile_1, up_acc__tile_1)):
            t__tile_Vec: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.tpop_from_aic(split=0)
            gate_acc__tile_2: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.add(gate_acc__iter_v2, t__tile_Vec)
            pl.system.tfree_to_aic(t__tile_Vec)
            t__tile_Vec_1: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.tpop_from_aic(split=0)
            up_acc__tile_2: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.add(up_acc__iter_v2, t__tile_Vec_1)
            pl.system.tfree_to_aic(t__tile_Vec_1)
            gate_acc__rv_v3, up_acc__rv_v3 = pl.yield_(gate_acc__tile_2, up_acc__tile_2)
        t__tile: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.neg(gate_acc__rv_v3)
        t__tile_1: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.exp(t__tile)
        t__tile_2: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.adds(t__tile_1, 1.0)
        sigmoid__tile: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.recip(t__tile_2)
        t__tile_3: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.mul(gate_acc__rv_v3, sigmoid__tile)
        mlp_chunk__tile: pl.Tile[[4, 64], pl.FP32, pl.Mem.Vec] = pl.tile.mul(t__tile_3, up_acc__rv_v3)
    ...
    def qwen3_prefill_layer_incore_9(self, gate_acc__ssa_v0: pl.Tensor[[4, 64], pl.FP32], o0__ssa_v1: pl.Scalar[pl.INDEX], post_norm_tile__rv_v2: pl.Tensor[[4, 5120], pl.BF16], up_acc__ssa_v0: pl.Tensor[[4, 64], pl.FP32], w_gate__ssa_v0: pl.Tensor[[5120, 25600], pl.BF16], w_up__ssa_v0: pl.Tensor[[5120, 25600], pl.BF16], ret0__out: pl.Out[pl.Tensor[[4, 64], pl.BF16]]) -> pl.Tensor[[4, 64], pl.BF16]:
        ...
        result: pl.Tensor[[4, 64], pl.BF16] = self.qwen3_prefill_layer_incore_9_aiv(gate_acc__ssa_v0, o0__ssa_v1, post_norm_tile__rv_v2, up_acc__ssa_v0, w_gate__ssa_v0, w_up__ssa_v0, ret0__out)
        return result
