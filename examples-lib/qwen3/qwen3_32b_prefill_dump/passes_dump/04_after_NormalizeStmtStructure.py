            ...
            for p0_idx__idx_v0, (k_cache__iter_v3, out__iter_v3, v_cache__iter_v3) in pl.range(tok_blocks__ssa_v0, init_values=(k_cache__iter_v1, out__iter_v1, v_cache__iter_v1)):
                ...
                with pl.auto_incore():
                    ...
                    for kb__idx_v0, (sq_sum__iter_v2,) in pl.range(20, init_values=(sq_sum__ssa_v1,)):
                        ...
                        x_chunk__ssa_v0: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(hidden_states__ssa_v0, [1, 4, 256], [b__idx_v0, p0__ssa_v0, k0__ssa_v0], [1, valid_tok__ssa_v0, 256]), target_type=pl.FP32, mode='round'), [4, 256])
                        sq_sum__ssa_v4: pl.Tensor[[4, 1], pl.FP32] = pl.tensor.add(sq_sum__iter_v2, pl.tensor.row_sum(pl.tensor.mul(x_chunk__ssa_v0, x_chunk__ssa_v0)))
                        sq_sum__rv_v3: pl.Tensor[[4, 1], pl.FP32] = pl.yield_(sq_sum__ssa_v4)
                    inv_rms__ssa_v0: pl.Tensor[[4, 1], pl.FP32] = pl.tensor.rsqrt(pl.tensor.adds(pl.tensor.muls(sq_sum__rv_v3, 0.000195313), 1e-06))
                    ...
                    for ob__idx_v0, (q_proj_tile__iter_v1,) in pl.parallel(80, init_values=(q_proj_tile__ssa_v0,), chunk=8):
                        ...
                        for kb__idx_v0_1, (q_acc__iter_v2,) in pl.range(20, init_values=(q_acc__ssa_v1,)):
                            ...
                            x_chunk__ssa_v1: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(hidden_states__ssa_v0, [1, 4, 256], [b__idx_v0, p0__ssa_v0, k0__ssa_v1], [1, valid_tok__ssa_v0, 256]), target_type=pl.FP32, mode='round'), [4, 256])
                            gamma__ssa_v0: pl.Tensor[[1, 256], pl.FP32] = pl.tensor.slice(input_rms_weight__ssa_v0, [1, 256], [0, k0__ssa_v1])
                            normed__ssa_v0: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk__ssa_v1, inv_rms__ssa_v0), gamma__ssa_v0)
                            wq_chunk__ssa_v0: pl.Tensor[[256, 64], pl.BF16] = pl.tensor.slice(wq__ssa_v0, [256, 64], [k0__ssa_v1, q0__ssa_v0])
                            q_acc__ssa_v4: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.add(q_acc__iter_v2, pl.tensor.matmul(pl.tensor.cast(normed__ssa_v0, target_type=pl.BF16, mode='round'), wq_chunk__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False))
                            q_acc__rv_v3: pl.Tensor[[4, 64], pl.FP32] = pl.yield_(q_acc__ssa_v4)
                        q_proj_tile__ssa_v3: pl.Tensor[[4, 5120], pl.BF16] = pl.tensor.assemble(q_proj_tile__iter_v1, pl.tensor.cast(q_acc__rv_v3, target_type=pl.BF16, mode='round'), [0, q0__ssa_v0])
                    ...
                    for ob__idx_v0_1, (k_proj_tile__iter_v1, v_proj_tile__iter_v1) in pl.parallel(32, init_values=(k_proj_tile__ssa_v0, v_proj_tile__ssa_v0), chunk=8):
                        ...
                        for kb__idx_v0_2, (k_acc__iter_v2, v_acc__iter_v2) in pl.range(20, init_values=(k_acc__ssa_v1, v_acc__ssa_v1)):
                            ...
                            x_chunk__ssa_v2: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(hidden_states__ssa_v0, [1, 4, 256], [b__idx_v0, p0__ssa_v0, k0__ssa_v2], [1, valid_tok__ssa_v0, 256]), target_type=pl.FP32, mode='round'), [4, 256])
                            gamma__ssa_v1: pl.Tensor[[1, 256], pl.FP32] = pl.tensor.slice(input_rms_weight__ssa_v0, [1, 256], [0, k0__ssa_v2])
                            normed__ssa_v1: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk__ssa_v2, inv_rms__ssa_v0), gamma__ssa_v1)
                            ...
                            k_acc__ssa_v4: pl.Tensor[[4, 32], pl.FP32] = pl.tensor.add(k_acc__iter_v2, pl.tensor.matmul(normed_bf16__ssa_v0, wk_chunk__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False))
                            v_acc__ssa_v4: pl.Tensor[[4, 32], pl.FP32] = pl.tensor.add(v_acc__iter_v2, pl.tensor.matmul(normed_bf16__ssa_v0, wv_chunk__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False))
                            k_acc__rv_v3, v_acc__rv_v3 = pl.yield_(k_acc__ssa_v4, v_acc__ssa_v4)
                        k_proj_tile__ssa_v3: pl.Tensor[[4, 1024], pl.BF16] = pl.tensor.assemble(k_proj_tile__iter_v1, pl.tensor.cast(k_acc__rv_v3, target_type=pl.BF16, mode='round'), [0, kv0__ssa_v0])
                        v_proj_tile__ssa_v3: pl.Tensor[[4, 1024], pl.BF16] = pl.tensor.assemble(v_proj_tile__iter_v1, pl.tensor.cast(v_acc__rv_v3, target_type=pl.BF16, mode='round'), [0, kv0__ssa_v0])
                ...
                for ti__idx_v0, (attn_tile__iter_v2, k_cache__iter_v5, v_cache__iter_v5) in pl.range(valid_tok__ssa_v0, init_values=(attn_tile__ssa_v1, k_cache__iter_v3, v_cache__iter_v3)):
                    ...
                    with pl.auto_incore():
                        ...
                        for kvh__idx_v0, (k_cache__iter_v7, v_cache__iter_v7) in pl.parallel(8, init_values=(k_cache__iter_v5, v_cache__iter_v5), chunk=4):
                            ...
                            k_row__ssa_v0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(pl.tensor.slice(k_proj_tile__rv_v2, [1, 128], [ti__idx_v0, kv_col__ssa_v0]), target_type=pl.FP32, mode='round')
                            ...
                            k_rot__ssa_v1: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.assemble(k_rot__ssa_v0, pl.tensor.sub(pl.tensor.col_expand_mul(k_lo__ssa_v0, cos_lo__ssa_v0), pl.tensor.col_expand_mul(k_hi__ssa_v0, sin_lo__ssa_v0)), [0, 0])
                            k_rot__ssa_v2: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.assemble(k_rot__ssa_v1, pl.tensor.add(pl.tensor.col_expand_mul(k_hi__ssa_v0, cos_hi__ssa_v0), pl.tensor.col_expand_mul(k_lo__ssa_v0, sin_hi__ssa_v0)), [0, 64])
                            cache_row__ssa_v0: pl.Scalar[pl.INDEX] = b__idx_v0 * 8 * 4096 + kvh__idx_v0 * 4096 + pos__ssa_v0
                            k_cache__ssa_v9: pl.Tensor[[524288, 128], pl.BF16] = pl.tensor.assemble(k_cache__iter_v7, pl.tensor.cast(k_rot__ssa_v2, target_type=pl.BF16, mode='round'), [cache_row__ssa_v0, 0])
                            v_cache__ssa_v9: pl.Tensor[[524288, 128], pl.BF16] = pl.tensor.assemble(v_cache__iter_v7, pl.tensor.slice(v_proj_tile__rv_v2, [1, 128], [ti__idx_v0, kv_col__ssa_v0]), [cache_row__ssa_v0, 0])
                        ...
                        for h__idx_v0, (attn_row__iter_v2,) in pl.parallel(64, init_values=(attn_row__ssa_v1,), chunk=8):
                            ...
                            q_row__ssa_v0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(pl.tensor.slice(q_proj_tile__rv_v2, [1, 128], [ti__idx_v0, q_col__ssa_v0]), target_type=pl.FP32, mode='round')
                            ...
                            q_rot__ssa_v1: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.assemble(q_rot__ssa_v0, pl.tensor.sub(pl.tensor.col_expand_mul(q_lo__ssa_v0, cos_lo__ssa_v0), pl.tensor.col_expand_mul(q_hi__ssa_v0, sin_lo__ssa_v0)), [0, 0])
                            q_rot__ssa_v2: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.assemble(q_rot__ssa_v1, pl.tensor.add(pl.tensor.col_expand_mul(q_hi__ssa_v0, cos_hi__ssa_v0), pl.tensor.col_expand_mul(q_lo__ssa_v0, sin_hi__ssa_v0)), [0, 64])
                            ...
                            for sb__idx_v0, (li__iter_v2, mi__iter_v2, oi__iter_v2) in pl.range(ctx_blocks__ssa_v0, init_values=(li__ssa_v1, mi__ssa_v1, oi__ssa_v1)):
                                ...
                                scores__ssa_v0: pl.Tensor[[1, 120], pl.FP32] = pl.tensor.muls(pl.tensor.matmul(q_rot_bf16__ssa_v0, k_tile__ssa_v0, a_trans=False, b_trans=True, c_matrix_nz=False), 0.0883883)
                                ...
                                cur_mi__ssa_v0: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.cast(pl.tensor.row_max(scores_valid__ssa_v0), target_type=pl.FP32, mode='round')
                                exp_scores__ssa_v0: pl.Tensor[[1, 120], pl.FP32] = pl.tensor.exp(pl.tensor.row_expand_sub(scores_valid__ssa_v0, cur_mi__ssa_v0))
                                cur_li__ssa_v0: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.cast(pl.tensor.row_sum(exp_scores__ssa_v0), target_type=pl.FP32, mode='round')
                                ...
                                oi_tmp__ssa_v0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.matmul(pl.tensor.cast(exp_pad__ssa_v2, target_type=pl.BF16, mode='round'), v_tile__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32)
                                if sb__idx_v0 == 0:
                                    ...
                                    alpha__ssa_v0: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.exp(pl.tensor.sub(mi__iter_v2, mi_new__ssa_v0))
                                    beta__ssa_v0: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.exp(pl.tensor.sub(cur_mi__ssa_v0, mi_new__ssa_v0))
                                    li__ssa_v5: pl.Tensor[[1, 1], pl.FP32] = pl.tensor.add(pl.tensor.mul(alpha__ssa_v0, li__iter_v2), pl.tensor.mul(beta__ssa_v0, cur_li__ssa_v0))
                                    oi__ssa_v5: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.add(pl.tensor.row_expand_mul(oi__iter_v2, alpha__ssa_v0), pl.tensor.row_expand_mul(oi_tmp__ssa_v0, beta__ssa_v0))
                ...
                with pl.auto_incore():
                    ...
                    for ob__idx_v0_2, (resid1_tile__iter_v1,) in pl.parallel(80, init_values=(resid1_tile__ssa_v0,), chunk=8):
                        ...
                        for kb__idx_v0_3, (o_acc__iter_v2,) in pl.range(20, init_values=(o_acc__ssa_v1,)):
                            ...
                            a_chunk__ssa_v0: pl.Tensor[[4, 256], pl.BF16] = pl.tensor.cast(pl.tensor.slice(attn_tile__rv_v3, [4, 256], [0, k0__ssa_v3]), target_type=pl.BF16, mode='round')
                            w_chunk__ssa_v0: pl.Tensor[[256, 64], pl.BF16] = pl.tensor.slice(wo__ssa_v0, [256, 64], [k0__ssa_v3, o0__ssa_v0])
                            o_acc__ssa_v4: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.add(o_acc__iter_v2, pl.tensor.matmul(a_chunk__ssa_v0, w_chunk__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False))
                            o_acc__rv_v3: pl.Tensor[[4, 64], pl.FP32] = pl.yield_(o_acc__ssa_v4)
                        resid__ssa_v0: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(hidden_states__ssa_v0, [1, 4, 64], [b__idx_v0, p0__ssa_v0, o0__ssa_v0], [1, valid_tok__ssa_v0, 64]), target_type=pl.FP32, mode='round'), [4, 64])
                        resid1_tile__ssa_v3: pl.Tensor[[4, 5120], pl.FP32] = pl.tensor.assemble(resid1_tile__iter_v1, pl.tensor.add(o_acc__rv_v3, resid__ssa_v0), [0, o0__ssa_v0])
                    ...
                    for kb__idx_v0_4, (sq_sum__iter_v7,) in pl.range(20, init_values=(sq_sum__ssa_v6,)):
                        ...
                        sq_sum__ssa_v9: pl.Tensor[[4, 1], pl.FP32] = pl.tensor.add(sq_sum__iter_v7, pl.tensor.row_sum(pl.tensor.mul(x_chunk__ssa_v3, x_chunk__ssa_v3)))
                        sq_sum__rv_v8: pl.Tensor[[4, 1], pl.FP32] = pl.yield_(sq_sum__ssa_v9)
                    inv_rms__ssa_v1: pl.Tensor[[4, 1], pl.FP32] = pl.tensor.rsqrt(pl.tensor.adds(pl.tensor.muls(sq_sum__rv_v8, 0.000195313), 1e-06))
                    ...
                    for kb__idx_v0_5, (post_norm_tile__iter_v1,) in pl.range(20, init_values=(post_norm_tile__ssa_v0,)):
                        ...
                        normed__ssa_v2: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk__ssa_v4, inv_rms__ssa_v1), gamma__ssa_v2)
                        post_norm_tile__ssa_v3: pl.Tensor[[4, 5120], pl.BF16] = pl.tensor.assemble(post_norm_tile__iter_v1, pl.tensor.cast(normed__ssa_v2, target_type=pl.BF16, mode='round'), [0, k0__ssa_v5])
                    ...
                    for ob__idx_v0_3, (down_proj_tile__iter_v2, out__iter_v5) in pl.range(400, init_values=(down_proj_tile__ssa_v1, out__iter_v3)):
                        ...
                        for kb__idx_v0_6, (gate_acc__iter_v2, up_acc__iter_v2) in pl.range(20, init_values=(gate_acc__ssa_v1, up_acc__ssa_v1)):
                            ...
                            gate_acc__ssa_v4: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.add(gate_acc__iter_v2, pl.tensor.matmul(post_chunk__ssa_v0, wg__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False))
                            up_acc__ssa_v4: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.add(up_acc__iter_v2, pl.tensor.matmul(post_chunk__ssa_v0, wu__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False))
                            gate_acc__rv_v3, up_acc__rv_v3 = pl.yield_(gate_acc__ssa_v4, up_acc__ssa_v4)
                        sigmoid__ssa_v0: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.recip(pl.tensor.adds(pl.tensor.exp(pl.tensor.neg(gate_acc__rv_v3)), 1.0))
                        mlp_chunk__ssa_v0: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.mul(pl.tensor.mul(gate_acc__rv_v3, sigmoid__ssa_v0), up_acc__rv_v3)
                        ...
                        for dob__idx_v0, (down_proj_tile__iter_v4, out__iter_v7) in pl.parallel(80, init_values=(down_proj_tile__iter_v2, out__iter_v5), chunk=8):
                            ...
                            down_next__ssa_v0: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.add(down_prev__ssa_v0, pl.tensor.matmul(mlp_chunk_bf16__ssa_v0, w_down_chunk__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False))
                            ...
                            if ob__idx_v0_3 == 399:
                                down_acc__ssa_v0: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.add(pl.tensor.slice(down_proj_tile__ssa_v6, [4, 64], [0, d0__ssa_v0]), pl.tensor.slice(resid1_tile__rv_v2, [4, 64], [0, d0__ssa_v0]))
                                out__ssa_v9: pl.Tensor[[16, 4096, 5120], pl.BF16] = pl.tensor.assemble(out__iter_v7, pl.tensor.cast(down_acc__ssa_v0, target_type=pl.BF16, mode='round'), [b__idx_v0, p0__ssa_v0, d0__ssa_v0])
