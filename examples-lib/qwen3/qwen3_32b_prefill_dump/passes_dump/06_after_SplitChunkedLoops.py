        ...
        for b__idx_v0, (k_cache__iter_v1, out__iter_v1, v_cache__iter_v1) in pl.parallel(16, init_values=(k_cache__ssa_v0, out__ssa_v0, v_cache__ssa_v0)):
            ...
            for p0_idx__idx_v0, (k_cache__iter_v3, out__iter_v3, v_cache__iter_v3) in pl.range(tok_blocks__ssa_v0, init_values=(k_cache__iter_v1, out__iter_v1, v_cache__iter_v1)):
                ...
                with pl.auto_incore():
                    ...
                    for ob__co_idx_v0, (q_proj_tile__co_iter_v1,) in pl.parallel(10, init_values=(q_proj_tile__ssa_v0,)):
                        for ob__ci_idx_v0, (q_proj_tile__ci_iter_v1,) in pl.parallel(8, init_values=(q_proj_tile__co_iter_v1,)):
                            ...
                            q_proj_tile__ssa_v3: pl.Tensor[[4, 5120], pl.BF16] = pl.tensor.assemble(q_proj_tile__ci_iter_v1, t__tmp_v11, [0, q0__ssa_v0])
                            q_proj_tile__ci_rv_v1: pl.Tensor[[4, 5120], pl.BF16] = pl.yield_(q_proj_tile__ssa_v3)
                        q_proj_tile__co_rv_v1: pl.Tensor[[4, 5120], pl.BF16] = pl.yield_(q_proj_tile__ci_rv_v1)
                    for ob__co_idx_v0_1, (k_proj_tile__co_iter_v1, v_proj_tile__co_iter_v1) in pl.parallel(4, init_values=(k_proj_tile__ssa_v0, v_proj_tile__ssa_v0)):
                        for ob__ci_idx_v0_1, (k_proj_tile__ci_iter_v1, v_proj_tile__ci_iter_v1) in pl.parallel(8, init_values=(k_proj_tile__co_iter_v1, v_proj_tile__co_iter_v1)):
                            kv0__ssa_v0: pl.Scalar[pl.INDEX] = (0 + (ob__co_idx_v0_1 * 8 + ob__ci_idx_v0_1) * 1) * 32
                            ...
                            k_proj_tile__ssa_v3: pl.Tensor[[4, 1024], pl.BF16] = pl.tensor.assemble(k_proj_tile__ci_iter_v1, t__tmp_v17, [0, kv0__ssa_v0])
                            t__tmp_v18: pl.Tensor[[4, 32], pl.BF16] = pl.tensor.cast(v_acc__rv_v3, target_type=pl.BF16, mode='round')
                            v_proj_tile__ssa_v3: pl.Tensor[[4, 1024], pl.BF16] = pl.tensor.assemble(v_proj_tile__ci_iter_v1, t__tmp_v18, [0, kv0__ssa_v0])
                            k_proj_tile__ci_rv_v1, v_proj_tile__ci_rv_v1 = pl.yield_(k_proj_tile__ssa_v3, v_proj_tile__ssa_v3)
                        k_proj_tile__co_rv_v1, v_proj_tile__co_rv_v1 = pl.yield_(k_proj_tile__ci_rv_v1, v_proj_tile__ci_rv_v1)
                ...
                for ti__idx_v0, (attn_tile__iter_v2, k_cache__iter_v5, v_cache__iter_v5) in pl.range(valid_tok__ssa_v0, init_values=(attn_tile__ssa_v1, k_cache__iter_v3, v_cache__iter_v3)):
                    ...
                    with pl.auto_incore():
                        ...
                        for kvh__co_idx_v0, (k_cache__co_iter_v7, v_cache__co_iter_v7) in pl.parallel(2, init_values=(k_cache__iter_v5, v_cache__iter_v5)):
                            for kvh__ci_idx_v0, (k_cache__ci_iter_v7, v_cache__ci_iter_v7) in pl.parallel(4, init_values=(k_cache__co_iter_v7, v_cache__co_iter_v7)):
                                kv_col__ssa_v0: pl.Scalar[pl.INDEX] = (0 + (kvh__co_idx_v0 * 4 + kvh__ci_idx_v0) * 1) * 128
                                t__tmp_v19: pl.Tensor[[1, 128], pl.BF16] = pl.tensor.slice(k_proj_tile__co_rv_v1, [1, 128], [ti__idx_v0, kv_col__ssa_v0])
                                ...
                                k_cache__ssa_v9: pl.Tensor[[524288, 128], pl.BF16] = pl.tensor.assemble(k_cache__ci_iter_v7, t__tmp_v26, [cache_row__ssa_v0, 0])
                                t__tmp_v27: pl.Tensor[[1, 128], pl.BF16] = pl.tensor.slice(v_proj_tile__co_rv_v1, [1, 128], [ti__idx_v0, kv_col__ssa_v0])
                                v_cache__ssa_v9: pl.Tensor[[524288, 128], pl.BF16] = pl.tensor.assemble(v_cache__ci_iter_v7, t__tmp_v27, [cache_row__ssa_v0, 0])
                                k_cache__ci_rv_v7, v_cache__ci_rv_v7 = pl.yield_(k_cache__ssa_v9, v_cache__ssa_v9)
                            k_cache__co_rv_v7, v_cache__co_rv_v7 = pl.yield_(k_cache__ci_rv_v7, v_cache__ci_rv_v7)
                        for h__co_idx_v0, (attn_row__co_iter_v2,) in pl.parallel(8, init_values=(attn_row__ssa_v1,)):
                            for h__ci_idx_v0, (attn_row__ci_iter_v2,) in pl.parallel(8, init_values=(attn_row__co_iter_v2,)):
                                ...
                                t__tmp_v28: pl.Tensor[[1, 128], pl.BF16] = pl.tensor.slice(q_proj_tile__co_rv_v1, [1, 128], [ti__idx_v0, q_col__ssa_v0])
                                ...
                                for sb__idx_v0, (li__iter_v2, mi__iter_v2, oi__iter_v2) in pl.range(ctx_blocks__ssa_v0, init_values=(li__ssa_v1, mi__ssa_v1, oi__ssa_v1)):
                                    ...
                                    k_tile__ssa_v0: pl.Tensor[[120, 128], pl.BF16, pl.TensorView(valid_shape=[valid_len, 128], stride=[], layout=pl.TensorLayout.ND)] = pl.tensor.slice(k_cache__co_rv_v7, [120, 128], [cache_row0__ssa_v0, 0], [valid_len__ssa_v0, 128])
                                    v_tile__ssa_v0: pl.Tensor[[120, 128], pl.BF16, pl.TensorView(valid_shape=[valid_len, 128], stride=[], layout=pl.TensorLayout.ND)] = pl.tensor.slice(v_cache__co_rv_v7, [120, 128], [cache_row0__ssa_v0, 0], [valid_len__ssa_v0, 128])
                                ...
                                attn_row__ssa_v4: pl.Tensor[[1, 5120], pl.FP32] = pl.tensor.assemble(attn_row__ci_iter_v2, ctx__ssa_v0, [0, q_col__ssa_v0])
                                attn_row__ci_rv_v2: pl.Tensor[[1, 5120], pl.FP32] = pl.yield_(attn_row__ssa_v4)
                            attn_row__co_rv_v2: pl.Tensor[[1, 5120], pl.FP32] = pl.yield_(attn_row__ci_rv_v2)
                        attn_tile__ssa_v4: pl.Tensor[[4, 5120], pl.FP32] = pl.tensor.assemble(attn_tile__iter_v2, attn_row__co_rv_v2, [ti__idx_v0, 0])
                    attn_tile__rv_v3, k_cache__rv_v6, v_cache__rv_v6 = pl.yield_(attn_tile__ssa_v4, k_cache__co_rv_v7, v_cache__co_rv_v7)
                with pl.auto_incore():
                    resid1_tile__ssa_v0: pl.Tensor[[4, 5120], pl.FP32] = pl.tensor.create([4, 5120], dtype=pl.FP32, layout=pl.TensorLayout.ND)
                    for ob__co_idx_v0_2, (resid1_tile__co_iter_v1,) in pl.parallel(10, init_values=(resid1_tile__ssa_v0,)):
                        for ob__ci_idx_v0_2, (resid1_tile__ci_iter_v1,) in pl.parallel(8, init_values=(resid1_tile__co_iter_v1,)):
                            o0__ssa_v0: pl.Scalar[pl.INDEX] = (0 + (ob__co_idx_v0_2 * 8 + ob__ci_idx_v0_2) * 1) * 64
                            ...
                            resid1_tile__ssa_v3: pl.Tensor[[4, 5120], pl.FP32] = pl.tensor.assemble(resid1_tile__ci_iter_v1, t__tmp_v50, [0, o0__ssa_v0])
                            resid1_tile__ci_rv_v1: pl.Tensor[[4, 5120], pl.FP32] = pl.yield_(resid1_tile__ssa_v3)
                        resid1_tile__co_rv_v1: pl.Tensor[[4, 5120], pl.FP32] = pl.yield_(resid1_tile__ci_rv_v1)
                    ...
                    for kb__idx_v0_4, (sq_sum__iter_v7,) in pl.range(20, init_values=(sq_sum__ssa_v6,)):
                        ...
                        x_chunk__ssa_v3: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.slice(resid1_tile__co_rv_v1, [4, 256], [0, k0__ssa_v4])
                    ...
                    for kb__idx_v0_5, (post_norm_tile__iter_v1,) in pl.range(20, init_values=(post_norm_tile__ssa_v0,)):
                        ...
                        x_chunk__ssa_v4: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.slice(resid1_tile__co_rv_v1, [4, 256], [0, k0__ssa_v5])
                    ...
                    for ob__idx_v0, (down_proj_tile__iter_v2, out__iter_v5) in pl.range(400, init_values=(down_proj_tile__ssa_v1, out__iter_v3)):
                        ...
                        for dob__co_idx_v0, (down_proj_tile__co_iter_v4, out__co_iter_v7) in pl.parallel(10, init_values=(down_proj_tile__iter_v2, out__iter_v5)):
                            for dob__ci_idx_v0, (down_proj_tile__ci_iter_v4, out__ci_iter_v7) in pl.parallel(8, init_values=(down_proj_tile__co_iter_v4, out__co_iter_v7)):
                                d0__ssa_v0: pl.Scalar[pl.INDEX] = (0 + (dob__co_idx_v0 * 8 + dob__ci_idx_v0) * 1) * 64
                                down_prev__ssa_v0: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.slice(down_proj_tile__ci_iter_v4, [4, 64], [0, d0__ssa_v0])
                                ...
                                down_proj_tile__ssa_v6: pl.Tensor[[4, 5120], pl.FP32] = pl.tensor.assemble(down_proj_tile__ci_iter_v4, down_next__ssa_v0, [0, d0__ssa_v0])
                                if ob__idx_v0 == 399:
                                    t__tmp_v64: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.slice(down_proj_tile__ssa_v6, [4, 64], [0, d0__ssa_v0])
                                    t__tmp_v65: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.slice(resid1_tile__co_rv_v1, [4, 64], [0, d0__ssa_v0])
                                    ...
                                    out__ssa_v9: pl.Tensor[[16, 4096, 5120], pl.BF16] = pl.tensor.assemble(out__ci_iter_v7, t__tmp_v66, [b__idx_v0, p0__ssa_v0, d0__ssa_v0])
                                    out__phi_v10: pl.Tensor[[16, 4096, 5120], pl.BF16] = pl.yield_(out__ssa_v9)
                                else:
                                    out__phi_v10: pl.Tensor[[16, 4096, 5120], pl.BF16] = pl.yield_(out__ci_iter_v7)
                                down_proj_tile__ci_rv_v4, out__ci_rv_v7 = pl.yield_(down_proj_tile__ssa_v6, out__phi_v10)
                            down_proj_tile__co_rv_v4, out__co_rv_v7 = pl.yield_(down_proj_tile__ci_rv_v4, out__ci_rv_v7)
                        down_proj_tile__rv_v3, out__rv_v6 = pl.yield_(down_proj_tile__co_rv_v4, out__co_rv_v7)
