...
class Qwen3SingleLayerPrefill:
    ...
    def qwen3_prefill_layer_incore_0(self, b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], p0__ssa_v0: pl.Scalar[pl.INDEX], sq_sum__ssa_v0: pl.Tensor[[4, 1], pl.FP32], valid_tok__ssa_v0: pl.Scalar[pl.INDEX]) -> pl.Tensor[[4, 1], pl.FP32]:
        ...
        return inv_rms__ssa_v0
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_prefill_layer_incore_1(self, b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], input_rms_weight__ssa_v0: pl.Tensor[[1, 5120], pl.FP32], inv_rms__ssa_v0: pl.Tensor[[4, 1], pl.FP32], ob__co_idx_v0: pl.Scalar[pl.INDEX], p0__ssa_v0: pl.Scalar[pl.INDEX], q_proj_tile__co_l0_iter_v1: pl.Tensor[[4, 5120], pl.BF16], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], wq__ssa_v0: pl.Tensor[[5120, 5120], pl.BF16]) -> pl.Tensor[[4, 5120], pl.BF16]:
        for ob__ci_idx_v0, (q_proj_tile__co_l1_iter_v1,) in pl.parallel(8, init_values=(q_proj_tile__co_l0_iter_v1,)):
            ...
            for kb__idx_v0, (q_acc__iter_v2,) in pl.range(20, init_values=(q_acc__ssa_v1,)):
            ...
            q_proj_tile__ssa_v3: pl.Tensor[[4, 5120], pl.BF16] = pl.tensor.assemble(q_proj_tile__co_l1_iter_v1, t__tmp_v11, [0, q0__ssa_v0])
            q_proj_tile__co_l1_rv_v1: pl.Tensor[[4, 5120], pl.BF16] = pl.yield_(q_proj_tile__ssa_v3)
        return q_proj_tile__co_l1_rv_v1
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_prefill_layer_incore_10(self, b__idx_v0: pl.Scalar[pl.INDEX], dob__co_idx_v0: pl.Scalar[pl.INDEX], down_proj_tile__co_l0_iter_v4: pl.Tensor[[4, 5120], pl.FP32], mlp_chunk_bf16__ssa_v0: pl.Tensor[[4, 64], pl.BF16], o0__ssa_v1: pl.Scalar[pl.INDEX], ob__idx_v0: pl.Scalar[pl.INDEX], out__co_l0_iter_v7: pl.Tensor[[16, 4096, 5120], pl.BF16], p0__ssa_v0: pl.Scalar[pl.INDEX], resid1_tile__co_l0_rv_v1: pl.Tensor[[4, 5120], pl.FP32], w_down__ssa_v0: pl.Tensor[[25600, 5120], pl.BF16]) -> tuple[pl.Tensor[[4, 5120], pl.FP32], pl.Tensor[[16, 4096, 5120], pl.BF16]]:
        for dob__ci_idx_v0, (down_proj_tile__co_l1_iter_v4, out__co_l1_iter_v7) in pl.parallel(8, init_values=(down_proj_tile__co_l0_iter_v4, out__co_l0_iter_v7)):
            ...
            down_prev__ssa_v0: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.slice(down_proj_tile__co_l1_iter_v4, [4, 64], [0, d0__ssa_v0])
            ...
            down_proj_tile__ssa_v6: pl.Tensor[[4, 5120], pl.FP32] = pl.tensor.assemble(down_proj_tile__co_l1_iter_v4, down_next__ssa_v0, [0, d0__ssa_v0])
            if ob__idx_v0 == 399:
                t__tmp_v64: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.slice(down_proj_tile__ssa_v6, [4, 64], [0, d0__ssa_v0])
                t__tmp_v65: pl.Tensor[[4, 64], pl.FP32] = pl.tensor.slice(resid1_tile__co_l0_rv_v1, [4, 64], [0, d0__ssa_v0])
                ...
                out__ssa_v9: pl.Tensor[[16, 4096, 5120], pl.BF16] = pl.tensor.assemble(out__co_l1_iter_v7, t__tmp_v66, [b__idx_v0, p0__ssa_v0, d0__ssa_v0])
            ...
            down_proj_tile__co_l1_rv_v4, out__co_l1_rv_v7 = pl.yield_(down_proj_tile__ssa_v6, out__phi_v10)
        return down_proj_tile__co_l1_rv_v4, out__co_l1_rv_v7
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_prefill_layer_incore_2(self, b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], input_rms_weight__ssa_v0: pl.Tensor[[1, 5120], pl.FP32], inv_rms__ssa_v0: pl.Tensor[[4, 1], pl.FP32], k_proj_tile__co_l0_iter_v1: pl.Tensor[[4, 1024], pl.BF16], ob__co_idx_v0: pl.Scalar[pl.INDEX], p0__ssa_v0: pl.Scalar[pl.INDEX], v_proj_tile__co_l0_iter_v1: pl.Tensor[[4, 1024], pl.BF16], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], wk__ssa_v0: pl.Tensor[[5120, 1024], pl.BF16], wv__ssa_v0: pl.Tensor[[5120, 1024], pl.BF16]) -> tuple[pl.Tensor[[4, 1024], pl.BF16], pl.Tensor[[4, 1024], pl.BF16]]:
        for ob__ci_idx_v0, (k_proj_tile__co_l1_iter_v1, v_proj_tile__co_l1_iter_v1) in pl.parallel(8, init_values=(k_proj_tile__co_l0_iter_v1, v_proj_tile__co_l0_iter_v1)):
            ...
            for kb__idx_v0, (k_acc__iter_v2, v_acc__iter_v2) in pl.range(20, init_values=(k_acc__ssa_v1, v_acc__ssa_v1)):
            ...
            k_proj_tile__ssa_v3: pl.Tensor[[4, 1024], pl.BF16] = pl.tensor.assemble(k_proj_tile__co_l1_iter_v1, t__tmp_v17, [0, kv0__ssa_v0])
            t__tmp_v18: pl.Tensor[[4, 32], pl.BF16] = pl.tensor.cast(v_acc__rv_v3, target_type=pl.BF16, mode='round')
            v_proj_tile__ssa_v3: pl.Tensor[[4, 1024], pl.BF16] = pl.tensor.assemble(v_proj_tile__co_l1_iter_v1, t__tmp_v18, [0, kv0__ssa_v0])
            k_proj_tile__co_l1_rv_v1, v_proj_tile__co_l1_rv_v1 = pl.yield_(k_proj_tile__ssa_v3, v_proj_tile__ssa_v3)
        return k_proj_tile__co_l1_rv_v1, v_proj_tile__co_l1_rv_v1
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_prefill_layer_incore_3(self, attn_row__ssa_v0: pl.Tensor[[1, 5120], pl.FP32]) -> pl.Tensor[[1, 5120], pl.FP32]:
        attn_row__ssa_v1: pl.Tensor[[1, 5120], pl.FP32] = pl.tensor.muls(attn_row__ssa_v0, 0.0)
        return attn_row__ssa_v1
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_prefill_layer_incore_4(self, b__idx_v0: pl.Scalar[pl.INDEX], cos_hi__ssa_v0: pl.Tensor[[1, 64], pl.FP32], cos_lo__ssa_v0: pl.Tensor[[1, 64], pl.FP32], k_cache__co_l0_iter_v7: pl.Tensor[[524288, 128], pl.BF16], k_proj_tile__co_l0_rv_v1: pl.Tensor[[4, 1024], pl.BF16], kvh__co_idx_v0: pl.Scalar[pl.INDEX], pos__ssa_v0: pl.Scalar[pl.INDEX], sin_hi__ssa_v0: pl.Tensor[[1, 64], pl.FP32], sin_lo__ssa_v0: pl.Tensor[[1, 64], pl.FP32], ti__idx_v0: pl.Scalar[pl.INDEX], v_cache__co_l0_iter_v7: pl.Tensor[[524288, 128], pl.BF16], v_proj_tile__co_l0_rv_v1: pl.Tensor[[4, 1024], pl.BF16]) -> tuple[pl.Tensor[[524288, 128], pl.BF16], pl.Tensor[[524288, 128], pl.BF16]]:
        for kvh__ci_idx_v0, (k_cache__co_l1_iter_v7, v_cache__co_l1_iter_v7) in pl.parallel(4, init_values=(k_cache__co_l0_iter_v7, v_cache__co_l0_iter_v7)):
            ...
            t__tmp_v19: pl.Tensor[[1, 128], pl.BF16] = pl.tensor.slice(k_proj_tile__co_l0_rv_v1, [1, 128], [ti__idx_v0, kv_col__ssa_v0])
    ...
    def qwen3_prefill_layer_incore_5(self, attn_row__co_l0_iter_v2: pl.Tensor[[1, 5120], pl.FP32], b__idx_v0: pl.Scalar[pl.INDEX], cos_hi__ssa_v0: pl.Tensor[[1, 64], pl.FP32], cos_lo__ssa_v0: pl.Tensor[[1, 64], pl.FP32], ctx_blocks__ssa_v0: pl.Scalar[pl.INDEX], ctx_len__ssa_v0: pl.Scalar[pl.INDEX], h__co_idx_v0: pl.Scalar[pl.INDEX], k_cache__co_l0_rv_v7: pl.Tensor[[524288, 128], pl.BF16], q_proj_tile__co_l0_rv_v1: pl.Tensor[[4, 5120], pl.BF16], sin_hi__ssa_v0: pl.Tensor[[1, 64], pl.FP32], sin_lo__ssa_v0: pl.Tensor[[1, 64], pl.FP32], ti__idx_v0: pl.Scalar[pl.INDEX], v_cache__co_l0_rv_v7: pl.Tensor[[524288, 128], pl.BF16]) -> pl.Tensor[[1, 5120], pl.FP32]:
        for h__ci_idx_v0, (attn_row__co_l1_iter_v2,) in pl.parallel(8, init_values=(attn_row__co_l0_iter_v2,)):
            ...
            t__tmp_v28: pl.Tensor[[1, 128], pl.BF16] = pl.tensor.slice(q_proj_tile__co_l0_rv_v1, [1, 128], [ti__idx_v0, q_col__ssa_v0])
            ...
            for sb__idx_v0, (li__iter_v2, mi__iter_v2, oi__iter_v2) in pl.range(ctx_blocks__ssa_v0, init_values=(li__ssa_v1, mi__ssa_v1, oi__ssa_v1)):
                ...
                k_tile__ssa_v0: pl.Tensor[[120, 128], pl.BF16, pl.TensorView(valid_shape=[valid_len, 128], stride=[], layout=pl.TensorLayout.ND)] = pl.tensor.slice(k_cache__co_l0_rv_v7, [120, 128], [cache_row0__ssa_v0, 0], [valid_len__ssa_v0, 128])
                v_tile__ssa_v0: pl.Tensor[[120, 128], pl.BF16, pl.TensorView(valid_shape=[valid_len, 128], stride=[], layout=pl.TensorLayout.ND)] = pl.tensor.slice(v_cache__co_l0_rv_v7, [120, 128], [cache_row0__ssa_v0, 0], [valid_len__ssa_v0, 128])
            ...
            attn_row__ssa_v4: pl.Tensor[[1, 5120], pl.FP32] = pl.tensor.assemble(attn_row__co_l1_iter_v2, ctx__ssa_v0, [0, q_col__ssa_v0])
            attn_row__co_l1_rv_v2: pl.Tensor[[1, 5120], pl.FP32] = pl.yield_(attn_row__ssa_v4)
        return attn_row__co_l1_rv_v2
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_prefill_layer_incore_6(self, attn_tile__rv_v3: pl.Tensor[[4, 5120], pl.FP32], b__idx_v0: pl.Scalar[pl.INDEX], hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], ob__co_idx_v0: pl.Scalar[pl.INDEX], p0__ssa_v0: pl.Scalar[pl.INDEX], resid1_tile__co_l0_iter_v1: pl.Tensor[[4, 5120], pl.FP32], valid_tok__ssa_v0: pl.Scalar[pl.INDEX], wo__ssa_v0: pl.Tensor[[5120, 5120], pl.BF16]) -> pl.Tensor[[4, 5120], pl.FP32]:
        for ob__ci_idx_v0, (resid1_tile__co_l1_iter_v1,) in pl.parallel(8, init_values=(resid1_tile__co_l0_iter_v1,)):
            ...
            for kb__idx_v0, (o_acc__iter_v2,) in pl.range(20, init_values=(o_acc__ssa_v1,)):
            ...
            resid1_tile__ssa_v3: pl.Tensor[[4, 5120], pl.FP32] = pl.tensor.assemble(resid1_tile__co_l1_iter_v1, t__tmp_v50, [0, o0__ssa_v0])
            resid1_tile__co_l1_rv_v1: pl.Tensor[[4, 5120], pl.FP32] = pl.yield_(resid1_tile__ssa_v3)
        return resid1_tile__co_l1_rv_v1
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_prefill_layer_incore_7(self, resid1_tile__co_l0_rv_v1: pl.Tensor[[4, 5120], pl.FP32], sq_sum__ssa_v5: pl.Tensor[[4, 1], pl.FP32]) -> pl.Tensor[[4, 1], pl.FP32]:
        sq_sum__ssa_v6: pl.Tensor[[4, 1], pl.FP32] = pl.tensor.muls(sq_sum__ssa_v5, 0.0)
        for kb__idx_v0, (sq_sum__iter_v7,) in pl.range(20, init_values=(sq_sum__ssa_v6,)):
            k0__ssa_v4: pl.Scalar[pl.INDEX] = kb__idx_v0 * 256
            x_chunk__ssa_v3: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.slice(resid1_tile__co_l0_rv_v1, [4, 256], [0, k0__ssa_v4])
        ...
        return inv_rms__ssa_v1
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_prefill_layer_incore_8(self, down_proj_tile__ssa_v0: pl.Tensor[[4, 5120], pl.FP32], inv_rms__ssa_v1: pl.Tensor[[4, 1], pl.FP32], post_norm_tile__ssa_v0: pl.Tensor[[4, 5120], pl.BF16], post_rms_weight__ssa_v0: pl.Tensor[[1, 5120], pl.FP32], resid1_tile__co_l0_rv_v1: pl.Tensor[[4, 5120], pl.FP32]) -> tuple[pl.Tensor[[4, 5120], pl.FP32], pl.Tensor[[4, 5120], pl.BF16]]:
        ...
        for kb__idx_v0, (post_norm_tile__iter_v1,) in pl.range(20, init_values=(post_norm_tile__ssa_v0,)):
            ...
            x_chunk__ssa_v4: pl.Tensor[[4, 256], pl.FP32] = pl.tensor.slice(resid1_tile__co_l0_rv_v1, [4, 256], [0, k0__ssa_v5])
    ...
    def qwen3_prefill_layer_incore_9(self, gate_acc__ssa_v0: pl.Tensor[[4, 64], pl.FP32], o0__ssa_v1: pl.Scalar[pl.INDEX], post_norm_tile__rv_v2: pl.Tensor[[4, 5120], pl.BF16], up_acc__ssa_v0: pl.Tensor[[4, 64], pl.FP32], w_gate__ssa_v0: pl.Tensor[[5120, 25600], pl.BF16], w_up__ssa_v0: pl.Tensor[[5120, 25600], pl.BF16]) -> pl.Tensor[[4, 64], pl.BF16]:
        ...
        for kb__idx_v0, (gate_acc__iter_v2, up_acc__iter_v2) in pl.range(20, init_values=(gate_acc__ssa_v1, up_acc__ssa_v1)):
    ...
    def qwen3_prefill_layer(self, hidden_states__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16], seq_lens__ssa_v0: pl.Tensor[[16], pl.INT32], rope_cos__ssa_v0: pl.Tensor[[4096, 128], pl.FP32], rope_sin__ssa_v0: pl.Tensor[[4096, 128], pl.FP32], k_cache__ssa_v0: pl.Tensor[[524288, 128], pl.BF16], v_cache__ssa_v0: pl.Tensor[[524288, 128], pl.BF16], input_rms_weight__ssa_v0: pl.Tensor[[1, 5120], pl.FP32], wq__ssa_v0: pl.Tensor[[5120, 5120], pl.BF16], wk__ssa_v0: pl.Tensor[[5120, 1024], pl.BF16], wv__ssa_v0: pl.Tensor[[5120, 1024], pl.BF16], wo__ssa_v0: pl.Tensor[[5120, 5120], pl.BF16], post_rms_weight__ssa_v0: pl.Tensor[[1, 5120], pl.FP32], w_gate__ssa_v0: pl.Tensor[[5120, 25600], pl.BF16], w_up__ssa_v0: pl.Tensor[[5120, 25600], pl.BF16], w_down__ssa_v0: pl.Tensor[[25600, 5120], pl.BF16], out__ssa_v0: pl.Tensor[[16, 4096, 5120], pl.BF16]) -> pl.Tensor[[16, 4096, 5120], pl.BF16]:
        for b__idx_v0, (k_cache__iter_v1, out__iter_v1, v_cache__iter_v1) in pl.parallel(16, init_values=(k_cache__ssa_v0, out__ssa_v0, v_cache__ssa_v0)):
            ...
            for p0_idx__idx_v0, (k_cache__iter_v3, out__iter_v3, v_cache__iter_v3) in pl.range(tok_blocks__ssa_v0, init_values=(k_cache__iter_v1, out__iter_v1, v_cache__iter_v1)):
                ...
                inv_rms__ssa_v0: pl.Tensor[[4, 1], pl.FP32] = self.qwen3_prefill_layer_incore_0(b__idx_v0, hidden_states__ssa_v0, p0__ssa_v0, sq_sum__ssa_v0, valid_tok__ssa_v0)
                ...
                for ti__idx_v0, (attn_tile__iter_v2, k_cache__iter_v5, v_cache__iter_v5) in pl.range(valid_tok__ssa_v0, init_values=(attn_tile__ssa_v1, k_cache__iter_v3, v_cache__iter_v3)):
                    ...
                    attn_row__ssa_v1: pl.Tensor[[1, 5120], pl.FP32] = self.qwen3_prefill_layer_incore_3(attn_row__ssa_v0)
                ...
                inv_rms__ssa_v1: pl.Tensor[[4, 1], pl.FP32] = self.qwen3_prefill_layer_incore_7(resid1_tile__co_l0_rv_v1, sq_sum__ssa_v5)
                ...
                ret__tmp_v0_2: pl.Tuple[pl.Tensor[[4, 5120], pl.FP32], pl.Tensor[[4, 5120], pl.BF16]] = self.qwen3_prefill_layer_incore_8(down_proj_tile__ssa_v0, inv_rms__ssa_v1, post_norm_tile__ssa_v0, post_rms_weight__ssa_v0, resid1_tile__co_l0_rv_v1)
                ...
                for ob__idx_v0, (down_proj_tile__iter_v2, out__iter_v5) in pl.range(400, init_values=(down_proj_tile__ssa_v1, out__iter_v3)):
                    ...
                    mlp_chunk_bf16__ssa_v0: pl.Tensor[[4, 64], pl.BF16] = self.qwen3_prefill_layer_incore_9(gate_acc__ssa_v0, o0__ssa_v1, post_norm_tile__rv_v2, up_acc__ssa_v0, w_gate__ssa_v0, w_up__ssa_v0)
