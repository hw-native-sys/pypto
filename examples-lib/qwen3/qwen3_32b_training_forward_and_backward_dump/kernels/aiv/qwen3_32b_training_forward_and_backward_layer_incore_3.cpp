// Kernel Function: qwen3_32b_training_forward_and_backward_layer_incore_3
...
static __aicore__ void qwen3_32b_training_forward_and_backward_layer_incore_3(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2) {
...
{
    // Unpack tensor: t__tmp_v72
    __gm__ TensorData* t__tmp_v72_tensor = reinterpret_cast<__gm__ TensorData*>(args[0]);
    __gm__ bfloat16_t* t__tmp_v72 = reinterpret_cast<__gm__ bfloat16_t*>(t__tmp_v72_tensor->buffer.addr) + t__tmp_v72_tensor->start_offset;
    ...
    qwen3_32b_training_forward_and_backward_layer_incore_3(t__tmp_v72, ret0__out);
}
