...
class Qwen332BTrainingForwardBackward:
            ...
            for p0_idx__idx_v0, (btrans_scratch__iter_v3, loss_acc__iter_v4, out__iter_v3) in pl.range(tok_blocks__ssa_v0, init_values=(btrans_scratch__cr_iter_v1, loss_acc__cr_iter_v2, out__cr_iter_v1)):
                ...
                for ob__idx_v0, (k_proj_tile__iter_v1, q_proj_tile__iter_v1, v_proj_tile__iter_v1) in pl.range(10, init_values=(k_proj_tile__tile, q_proj_tile__tile, v_proj_tile__tile)):
                    ...
                    for kb__idx_v0_2, (k_acc__iter_v2, q_acc__iter_v2, v_acc__iter_v2) in pl.range(20, init_values=(k_acc__tile_1, q_acc__tile_1, v_acc__tile_1)):
                        ...
                        n_chunk__tile_Left: pl.Tile[[2, 4], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(n_chunk__tile, target_memory=pl.Mem.Left)
                        ...
                        t__tile_11: pl.Tile[[2, 8], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(n_chunk__tile_Left, wq_c__tile_Right)
                        t__tile_Vec: pl.Tile[[2, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_11, target_memory=pl.Mem.Vec)
                        q_acc__tile_2: pl.Tile[[2, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(q_acc__iter_v2, t__tile_Vec)
                        t__tile_12: pl.Tile[[2, 8], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(n_chunk__tile_Left, wk_c__tile_Right)
                        t__tile_Vec_1: pl.Tile[[2, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_12, target_memory=pl.Mem.Vec)
                        k_acc__tile_2: pl.Tile[[2, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(k_acc__iter_v2, t__tile_Vec_1)
                        t__tile_13: pl.Tile[[2, 8], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(n_chunk__tile_Left, wv_c__tile_Right)
                        t__tile_Vec_2: pl.Tile[[2, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_13, target_memory=pl.Mem.Vec)
                ...
                for kb__idx_v0_3, (btrans_scratch__iter_v5, scores__iter_v2) in pl.range(20, init_values=(btrans_scratch__iter_v3, scores__tile_1)):
                    ...
                    q_c__tile_Left: pl.Tile[[2, 4], pl.FP32, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(q_c__tile, target_memory=pl.Mem.Left)
                    ...
                    t__tile_19: pl.Tile[[2, 2], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(q_c__tile_Left, k_c_t__tile_Right)
                    t__tile_Vec_3: pl.Tile[[2, 2], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_19, target_memory=pl.Mem.Vec)
                ...
                t__tile_20: pl.Tile[[2, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(t__row_major_tmp_v12, [2, 1])
                attn_w__tile: pl.Tile[[2, 2], pl.FP32, pl.Mem.Vec] = pl.tile.row_expand_mul(scores_exp__tile, t__tile_20)
                attn_w__tile_Left: pl.Tile[[2, 2], pl.FP32, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(attn_w__tile, target_memory=pl.Mem.Left)
                ...
                for ob__idx_v0_1, (context_tile__iter_v1,) in pl.range(10, init_values=(context_tile__tile,)):
                    ...
                    v_c__tile_Right: pl.Tile[[2, 8], pl.FP32, pl.Mem.Right, pl.TileView(slayout=pl.TileLayout.col_major)] = pl.tile.move(v_c__tile, target_memory=pl.Mem.Right)
                    ...
                    t__tile_22: pl.Tile[[2, 8], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(attn_w__tile_Left, v_c__tile_Right)
                    t__tile_Vec_4: pl.Tile[[2, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_22, target_memory=pl.Mem.Vec)
                ...
                for ob__idx_v0_2, (resid1_tile__iter_v1,) in pl.range(10, init_values=(resid1_tile__tile,)):
                    ...
                    for kb__idx_v0_4, (o_acc__iter_v2,) in pl.range(20, init_values=(o_acc__tile_1,)):
                        ...
                        ctx_chunk__tile_Left: pl.Tile[[2, 4], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(ctx_chunk__tile, target_memory=pl.Mem.Left)
                        ...
                        t__tile_24: pl.Tile[[2, 8], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(ctx_chunk__tile_Left, wo_c__tile_Right)
                        t__tile_Vec_5: pl.Tile[[2, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_24, target_memory=pl.Mem.Vec)
                ...
                for kb__idx_v0_5, (sq_sum2__iter_v2,) in pl.range(20, init_values=(sq_sum2__tile_1,)):
                    ...
                    sq_sum2__rm_a1_tmp_v16: pl.Tile[[1, 2], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_29, [1, 2])
                ...
                t__tile_30: pl.Tile[[2, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(t__row_major_tmp_v19, [2, 1])
                t__rm_a0_tmp_v20: pl.Tile[[1, 2], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_30, [1, 2])
                t__row_major_tmp_v21: pl.Tile[[1, 2], pl.FP32, pl.Mem.Vec] = pl.tile.adds(t__rm_a0_tmp_v20, 1e-06)
                t__tile_31: pl.Tile[[2, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(t__row_major_tmp_v21, [2, 1])
                inv_rms2__rm_a0_tmp_v22: pl.Tile[[1, 2], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_31, [1, 2])
                ...
                for mb__idx_v0, (down_tile__iter_v2,) in pl.range(25, init_values=(down_tile__tile_1,)):
                    ...
                    for kb__idx_v0_7, (gate_acc__iter_v2, up_acc__iter_v2) in pl.range(20, init_values=(gate_acc__tile_1, up_acc__tile_1)):
                        ...
                        post_chunk__tile_Left: pl.Tile[[2, 4], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(post_chunk__tile, target_memory=pl.Mem.Left)
                        ...
                        t__tile_34: pl.Tile[[2, 16], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(post_chunk__tile_Left, wg__tile_Right)
                        t__tile_Vec_6: pl.Tile[[2, 16], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_34, target_memory=pl.Mem.Vec)
                        gate_acc__tile_2: pl.Tile[[2, 16], pl.FP32, pl.Mem.Vec] = pl.tile.add(gate_acc__iter_v2, t__tile_Vec_6)
                        t__tile_35: pl.Tile[[2, 16], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(post_chunk__tile_Left, wu__tile_Right)
                        t__tile_Vec_7: pl.Tile[[2, 16], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_35, target_memory=pl.Mem.Vec)
                    ...
                    mlp_chunk__tile_Left: pl.Tile[[2, 16], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(mlp_chunk__tile, target_memory=pl.Mem.Left)
                    for ob__idx_v0_3, (down_tile__iter_v4,) in pl.range(10, init_values=(down_tile__iter_v2,)):
                        ...
                        t__tile_41: pl.Tile[[2, 8], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(mlp_chunk__tile_Left, wd__tile_Right)
                        t__tile_Vec_8: pl.Tile[[2, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_41, target_memory=pl.Mem.Vec)
                ...
                t__tile_48: pl.Tile[[2, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(t__row_major_tmp_v26, [2, 1])
                ...
                for mb__idx_v0_1, (d_post_norm__iter_v2,) in pl.range(25, init_values=(d_post_norm__tile_1,)):
                    ...
                    for kb__idx_v0_8, (gate_r__iter_v2, up_r__iter_v2) in pl.range(20, init_values=(gate_r__tile_1, up_r__tile_1)):
                        ...
                        post_c__tile_Left: pl.Tile[[2, 4], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(post_c__tile, target_memory=pl.Mem.Left)
                        ...
                        t__tile_49: pl.Tile[[2, 16], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(post_c__tile_Left, wg_c__tile_Right)
                        t__tile_Vec_9: pl.Tile[[2, 16], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_49, target_memory=pl.Mem.Vec)
                        gate_r__tile_2: pl.Tile[[2, 16], pl.FP32, pl.Mem.Vec] = pl.tile.add(gate_r__iter_v2, t__tile_Vec_9)
                        t__tile_50: pl.Tile[[2, 16], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(post_c__tile_Left, wu_c__tile_Right)
                        t__tile_Vec_10: pl.Tile[[2, 16], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_50, target_memory=pl.Mem.Vec)
                    ...
                    for ob__idx_v0_5, (d_mlp__iter_v2,) in pl.range(10, init_values=(d_mlp__tile_1,)):
                        ...
                        dd_c__tile_Left: pl.Tile[[2, 8], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(dd_c__tile, target_memory=pl.Mem.Left)
                        ...
                        t__tile_55: pl.Tile[[2, 16], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(dd_c__tile_Left, wd_c__tile_Right)
                        t__tile_Vec_11: pl.Tile[[2, 16], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_55, target_memory=pl.Mem.Vec)
                    ...
                    d_gate_bf16__tile_Left: pl.Tile[[2, 16], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(d_gate_bf16__tile, target_memory=pl.Mem.Left)
                    ...
                    d_up_bf16__tile_Left: pl.Tile[[2, 16], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(d_up_bf16__tile, target_memory=pl.Mem.Left)
                    for kb__idx_v0_9, (d_post_norm__iter_v4,) in pl.range(20, init_values=(d_post_norm__iter_v2,)):
                        ...
                        t__tile_63: pl.Tile[[2, 4], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(d_gate_bf16__tile_Left, wg_c__tile_Right_1)
                        t__tile_Vec_12: pl.Tile[[2, 4], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_63, target_memory=pl.Mem.Vec)
                        dpn_tmp__tile: pl.Tile[[2, 4], pl.FP32, pl.Mem.Vec] = pl.tile.add(dpn_old__tile, t__tile_Vec_12)
                        t__tile_64: pl.Tile[[2, 4], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(d_up_bf16__tile_Left, wu_c__tile_Right_1)
                        t__tile_Vec_13: pl.Tile[[2, 4], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_64, target_memory=pl.Mem.Vec)
                ...
                bwd_energy__rm_a0_tmp_v32: pl.Tile[[1, 2], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(bwd_energy__rv_v3, [1, 2])
                bwd_energy__rm_a1_tmp_v33: pl.Tile[[1, 2], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_71, [1, 2])
                bwd_energy__row_major_tmp_v34: pl.Tile[[1, 2], pl.FP32, pl.Mem.Vec] = pl.tile.add(bwd_energy__rm_a0_tmp_v32, bwd_energy__rm_a1_tmp_v33)
                bwd_energy__tile_3: pl.Tile[[2, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(bwd_energy__row_major_tmp_v34, [2, 1])
                grad_sink__rm_a0_tmp_v35: pl.Tile[[1, 2], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(bwd_energy__tile_3, [1, 2])
                grad_sink__row_major_tmp_v36: pl.Tile[[1, 2], pl.FP32, pl.Mem.Vec] = pl.tile.muls(grad_sink__rm_a0_tmp_v35, 0.0)
                grad_sink__tile: pl.Tile[[2, 1], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.reshape(grad_sink__row_major_tmp_v36, [2, 1])
    ...
    def qwen3_32b_training_forward_and_backward_layer_incore_4(self, grad_w_down__ssa_v1: pl.Out[pl.Tensor[[400, 80], pl.FP32]], mom_w_down__ssa_v0: pl.InOut[pl.Tensor[[400, 80], pl.FP32]], muon_scratch__ssa_v0: pl.InOut[pl.Tensor[[16, 16], pl.BF16]], proxy_mlp_t__ssa_v0: pl.Tensor[[16, 2], pl.BF16, pl.TensorView(stride=[], layout=pl.TensorLayout.DN)], proxy_scratch__ssa_v1: pl.InOut[pl.Tensor[[2, 16], pl.BF16]], target_states__ssa_v0: pl.Tensor[[1, 4, 80], pl.BF16]) -> tuple[pl.Tensor[[400, 80], pl.FP32], pl.Tensor[[400, 80], pl.FP32], pl.Tensor[[16, 16], pl.BF16], pl.Tensor[[2, 16], pl.BF16]]:
        for qb__idx_v0, (grad_w_down__iter_v2, mom_w_down__iter_v1, muon_scratch__iter_v1, proxy_scratch__iter_v2) in pl.range(10, init_values=(grad_w_down__ssa_v1, mom_w_down__ssa_v0, muon_scratch__ssa_v0, proxy_scratch__ssa_v1)):
            ...
            grad_down_raw__tile_Vec: pl.Tile[[16, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(grad_down_raw__tile, target_memory=pl.Mem.Vec)
            ...
            t__tile_3: pl.Tile[[16, 8], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(grad_down_raw__tile_Vec, 0.05)
            mom_down_new__rm_a1_tmp_v0: pl.Tile[[16, 8], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_3, [16, 8])
            mom_down_new__tile: pl.Tile[[16, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_2, mom_down_new__rm_a1_tmp_v0)
            ...
            for ___idx_v0, (muon_down__iter_v1,) in pl.range(2, init_values=(muon_down__ssa_v0,)):
                ...
                for tb__idx_v0, (gram__iter_v2,) in pl.range(8, init_values=(gram__tile_1,)):
                    ...
                    t__tile_5: pl.Tile[[8, 8], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(m_blk_t__tile_Left, m_blk__tile_Right)
                    t__tile_Vec: pl.Tile[[8, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_5, target_memory=pl.Mem.Vec)
                ...
                t__tile_Vec_1: pl.Tile[[16, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_7, target_memory=pl.Mem.Vec)
                t__tile_8: pl.Tile[[16, 8], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(t__tile_Vec_1, -0.5)
                muon_down__rm_a1_tmp_v1: pl.Tile[[16, 8], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_8, [16, 8])
                muon_down__tile: pl.Tile[[16, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_6, muon_down__rm_a1_tmp_v1)
    ...
    def qwen3_32b_training_forward_and_backward_layer_incore_7(self, grad_wk__ssa_v1: pl.Out[pl.Tensor[[80, 80], pl.FP32]], grad_wo__ssa_v1: pl.Out[pl.Tensor[[80, 80], pl.FP32]], grad_wq__ssa_v1: pl.Out[pl.Tensor[[80, 80], pl.FP32]], grad_wv__ssa_v1: pl.Out[pl.Tensor[[80, 80], pl.FP32]], mom_wk__ssa_v0: pl.InOut[pl.Tensor[[80, 80], pl.FP32]], mom_wo__ssa_v0: pl.InOut[pl.Tensor[[80, 80], pl.FP32]], mom_wq__ssa_v0: pl.InOut[pl.Tensor[[80, 80], pl.FP32]], mom_wv__ssa_v0: pl.InOut[pl.Tensor[[80, 80], pl.FP32]], muon_scratch__rv_v2: pl.InOut[pl.Tensor[[16, 16], pl.BF16]], proxy_ctx_t__ssa_v0: pl.Tensor[[4, 2], pl.BF16, pl.TensorView(stride=[], layout=pl.TensorLayout.DN)], proxy_n_t__ssa_v0: pl.Tensor[[4, 2], pl.BF16, pl.TensorView(stride=[], layout=pl.TensorLayout.DN)], proxy_scratch__ssa_v6: pl.InOut[pl.Tensor[[2, 16], pl.BF16]], target_states__ssa_v0: pl.Tensor[[1, 4, 80], pl.BF16]) -> tuple[pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[16, 16], pl.BF16], pl.Tensor[[2, 16], pl.BF16]]:
        for qb__idx_v0, (grad_wk__iter_v2, grad_wo__iter_v2, grad_wq__iter_v2, grad_wv__iter_v2, mom_wk__iter_v1, mom_wo__iter_v1, mom_wq__iter_v1, mom_wv__iter_v1, muon_scratch__iter_v4, proxy_scratch__iter_v7) in pl.range(10, init_values=(grad_wk__ssa_v1, grad_wo__ssa_v1, grad_wq__ssa_v1, grad_wv__ssa_v1, mom_wk__ssa_v0, mom_wo__ssa_v0, mom_wq__ssa_v0, mom_wv__ssa_v0, muon_scratch__rv_v2, proxy_scratch__ssa_v6)):
            ...
            grad_wo_raw__tile_Vec: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(grad_wo_raw__tile, target_memory=pl.Mem.Vec)
            ...
            t__tile_3: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(grad_wo_raw__tile_Vec, 0.05)
            mom_wo_new__rm_a1_tmp_v0: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_3, [4, 8])
            mom_wo_new__tile: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_2, mom_wo_new__rm_a1_tmp_v0)
            ...
            for ___idx_v0, (muon_wo__iter_v1,) in pl.range(2, init_values=(muon_wo__ssa_v0,)):
                ...
                t__tile_Vec_1: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_7, target_memory=pl.Mem.Vec)
                t__tile_8: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(t__tile_Vec_1, -0.5)
                muon_wo__rm_a1_tmp_v1: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_8, [4, 8])
                muon_wo__tile: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_6, muon_wo__rm_a1_tmp_v1)
            ...
            grad_wq_raw__tile_Vec: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(grad_wq_raw__tile, target_memory=pl.Mem.Vec)
            ...
            t__tile_11: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(grad_wq_raw__tile_Vec, 0.05)
            mom_wq_new__rm_a1_tmp_v2: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_11, [4, 8])
            mom_wq_new__tile: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_10, mom_wq_new__rm_a1_tmp_v2)
            ...
            for ___idx_v0_1, (muon_wq__iter_v1,) in pl.range(2, init_values=(muon_wq__ssa_v0,)):
                ...
                for tb__idx_v0_1, (gram__iter_v12,) in pl.range(2, init_values=(gram__tile_4,)):
                    ...
                    m_blk_t__tile_Left_1: pl.Tile[[8, 2], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(m_blk_t__tile_1, target_memory=pl.Mem.Left)
                    t__tile_13: pl.Tile[[8, 8], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(m_blk_t__tile_Left_1, m_blk__tile_Right_1)
                    t__tile_Vec_2: pl.Tile[[8, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_13, target_memory=pl.Mem.Vec)
                ...
                t__tile_Vec_3: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_15, target_memory=pl.Mem.Vec)
                t__tile_16: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(t__tile_Vec_3, -0.5)
                muon_wq__rm_a1_tmp_v3: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_16, [4, 8])
                muon_wq__tile: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_14, muon_wq__rm_a1_tmp_v3)
            ...
            grad_wk_raw__tile_Vec: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(grad_wk_raw__tile, target_memory=pl.Mem.Vec)
            ...
            t__tile_19: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(grad_wk_raw__tile_Vec, 0.05)
            mom_wk_new__rm_a1_tmp_v4: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_19, [4, 8])
            mom_wk_new__tile: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_18, mom_wk_new__rm_a1_tmp_v4)
            ...
            for ___idx_v0_2, (muon_wk__iter_v1,) in pl.range(2, init_values=(muon_wk__ssa_v0,)):
                ...
                for tb__idx_v0_2, (gram__iter_v17,) in pl.range(2, init_values=(gram__tile_7,)):
                    ...
                    m_blk_t__tile_Left_2: pl.Tile[[8, 2], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(m_blk_t__tile_2, target_memory=pl.Mem.Left)
                    t__tile_21: pl.Tile[[8, 8], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(m_blk_t__tile_Left_2, m_blk__tile_Right_2)
                    t__tile_Vec_4: pl.Tile[[8, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_21, target_memory=pl.Mem.Vec)
                ...
                t__tile_Vec_5: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_23, target_memory=pl.Mem.Vec)
                t__tile_24: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(t__tile_Vec_5, -0.5)
                muon_wk__rm_a1_tmp_v5: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_24, [4, 8])
                muon_wk__tile: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_22, muon_wk__rm_a1_tmp_v5)
            ...
            grad_wv_raw__tile_Vec: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(grad_wv_raw__tile, target_memory=pl.Mem.Vec)
            ...
            t__tile_27: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(grad_wv_raw__tile_Vec, 0.05)
            mom_wv_new__rm_a1_tmp_v6: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_27, [4, 8])
            mom_wv_new__tile: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_26, mom_wv_new__rm_a1_tmp_v6)
            ...
            for ___idx_v0_3, (muon_wv__iter_v1,) in pl.range(2, init_values=(muon_wv__ssa_v0,)):
                ...
                for tb__idx_v0_3, (gram__iter_v22,) in pl.range(2, init_values=(gram__tile_10,)):
                    ...
                    m_blk_t__tile_Left_3: pl.Tile[[8, 2], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(m_blk_t__tile_3, target_memory=pl.Mem.Left)
                    t__tile_29: pl.Tile[[8, 8], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(m_blk_t__tile_Left_3, m_blk__tile_Right_3)
                    t__tile_Vec_6: pl.Tile[[8, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_29, target_memory=pl.Mem.Vec)
                ...
                t__tile_Vec_7: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_31, target_memory=pl.Mem.Vec)
                t__tile_32: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(t__tile_Vec_7, -0.5)
                muon_wv__rm_a1_tmp_v7: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_32, [4, 8])
                muon_wv__tile: pl.Tile[[4, 8], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_30, muon_wv__rm_a1_tmp_v7)
    ...
    def qwen3_32b_training_forward_and_backward_layer_incore_9(self, grad_w_gate__ssa_v1: pl.Out[pl.Tensor[[80, 400], pl.FP32]], grad_w_up__ssa_v1: pl.Out[pl.Tensor[[80, 400], pl.FP32]], mom_w_gate__ssa_v0: pl.InOut[pl.Tensor[[80, 400], pl.FP32]], mom_w_up__ssa_v0: pl.InOut[pl.Tensor[[80, 400], pl.FP32]], muon_scratch__rv_v5: pl.InOut[pl.Tensor[[16, 16], pl.BF16]], proxy_post_t__ssa_v0: pl.Tensor[[4, 2], pl.BF16, pl.TensorView(stride=[], layout=pl.TensorLayout.DN)], proxy_scratch__ssa_v10: pl.InOut[pl.Tensor[[2, 16], pl.BF16]], w_gate__ssa_v0: pl.Tensor[[80, 400], pl.BF16], w_up__ssa_v0: pl.Tensor[[80, 400], pl.BF16]) -> tuple[pl.Tensor[[80, 400], pl.FP32], pl.Tensor[[80, 400], pl.FP32], pl.Tensor[[80, 400], pl.FP32], pl.Tensor[[80, 400], pl.FP32]]:
        for mb__idx_v0, (grad_w_gate__iter_v2, grad_w_up__iter_v2, mom_w_gate__iter_v1, mom_w_up__iter_v1, muon_scratch__iter_v10, proxy_scratch__iter_v11) in pl.range(25, init_values=(grad_w_gate__ssa_v1, grad_w_up__ssa_v1, mom_w_gate__ssa_v0, mom_w_up__ssa_v0, muon_scratch__rv_v5, proxy_scratch__ssa_v10)):
            ...
            grad_wg_raw__tile_Vec: pl.Tile[[4, 16], pl.FP32, pl.Mem.Vec] = pl.tile.move(grad_wg_raw__tile, target_memory=pl.Mem.Vec)
            ...
            grad_wu_raw__tile_Vec: pl.Tile[[4, 16], pl.FP32, pl.Mem.Vec] = pl.tile.move(grad_wu_raw__tile, target_memory=pl.Mem.Vec)
            ...
            t__tile_3: pl.Tile[[4, 16], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(grad_wg_raw__tile_Vec, 0.05)
            mom_wg_new__rm_a1_tmp_v0: pl.Tile[[4, 16], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_3, [4, 16])
            mom_wg_new__tile: pl.Tile[[4, 16], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_2, mom_wg_new__rm_a1_tmp_v0)
            t__tile_4: pl.Tile[[4, 16], pl.FP32, pl.Mem.Vec] = pl.tile.muls(mom_wu_prev__tile, 0.95)
            t__tile_5: pl.Tile[[4, 16], pl.FP32, pl.Mem.Vec, pl.TileView(blayout=pl.TileLayout.col_major)] = pl.tile.muls(grad_wu_raw__tile_Vec, 0.05)
            mom_wu_new__rm_a1_tmp_v1: pl.Tile[[4, 16], pl.FP32, pl.Mem.Vec] = pl.tile.reshape(t__tile_5, [4, 16])
            mom_wu_new__tile: pl.Tile[[4, 16], pl.FP32, pl.Mem.Vec] = pl.tile.add(t__tile_4, mom_wu_new__rm_a1_tmp_v1)
            ...
            for ___idx_v0, (muon_wg__iter_v1,) in pl.range(2, init_values=(muon_wg__ssa_v0,)):
                ...
                muon_wg_bf__tile_Left: pl.Tile[[4, 16], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(muon_wg_bf__tile, target_memory=pl.Mem.Left)
                for tb__idx_v0, (ns_acc_g__iter_v2,) in pl.range(2, init_values=(ns_acc_g__tile_1,)):
                    ...
                    tmp_g__tile_Vec: pl.Tile[[4, 2], pl.FP32, pl.Mem.Vec] = pl.tile.move(tmp_g__tile, target_memory=pl.Mem.Vec)
                    ...
                    tmp_g_bf__tile_Left: pl.Tile[[4, 2], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(tmp_g_bf__tile, target_memory=pl.Mem.Left)
                    t__tile_7: pl.Tile[[4, 16], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(tmp_g_bf__tile_Left, m_blk_g__tile_Right)
                    t__tile_Vec: pl.Tile[[4, 16], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_7, target_memory=pl.Mem.Vec)
            ...
            for ___idx_v0_1, (muon_wu__iter_v1,) in pl.range(2, init_values=(muon_wu__ssa_v0,)):
                ...
                muon_wu_bf__tile_Left: pl.Tile[[4, 16], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(muon_wu_bf__tile, target_memory=pl.Mem.Left)
                for tb__idx_v0_1, (ns_acc_u__iter_v2,) in pl.range(2, init_values=(ns_acc_u__tile_1,)):
                    ...
                    tmp_u__tile_Vec: pl.Tile[[4, 2], pl.FP32, pl.Mem.Vec] = pl.tile.move(tmp_u__tile, target_memory=pl.Mem.Vec)
                    ...
                    tmp_u_bf__tile_Left: pl.Tile[[4, 2], pl.BF16, pl.Mem.Left, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major)] = pl.tile.move(tmp_u_bf__tile, target_memory=pl.Mem.Left)
                    t__tile_11: pl.Tile[[4, 16], pl.FP32, pl.Mem.Acc, pl.TileView(blayout=pl.TileLayout.col_major, slayout=pl.TileLayout.row_major, fractal=1024)] = pl.tile.matmul(tmp_u_bf__tile_Left, m_blk_u__tile_Right)
                    t__tile_Vec_1: pl.Tile[[4, 16], pl.FP32, pl.Mem.Vec] = pl.tile.move(t__tile_11, target_memory=pl.Mem.Vec)
