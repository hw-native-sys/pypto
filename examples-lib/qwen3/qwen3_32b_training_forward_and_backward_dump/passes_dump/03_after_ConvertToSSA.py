...
class Qwen332BTrainingForwardBackward:
    ...
    def qwen3_32b_training_forward_and_backward_layer(self, hidden_states__ssa_v0: pl.Tensor[[1, 4, 80], pl.BF16], target_states__ssa_v0: pl.Tensor[[1, 4, 80], pl.BF16], input_rms_weight__ssa_v0: pl.Tensor[[1, 80], pl.FP32], post_rms_weight__ssa_v0: pl.Tensor[[1, 80], pl.FP32], wq__ssa_v0: pl.Tensor[[80, 80], pl.BF16], wk__ssa_v0: pl.Tensor[[80, 80], pl.BF16], wv__ssa_v0: pl.Tensor[[80, 80], pl.BF16], wo__ssa_v0: pl.Tensor[[80, 80], pl.BF16], w_gate__ssa_v0: pl.Tensor[[80, 400], pl.BF16], w_up__ssa_v0: pl.Tensor[[80, 400], pl.BF16], w_down__ssa_v0: pl.Tensor[[400, 80], pl.BF16], mom_wq__ssa_v0: pl.Tensor[[80, 80], pl.FP32], mom_wk__ssa_v0: pl.Tensor[[80, 80], pl.FP32], mom_wv__ssa_v0: pl.Tensor[[80, 80], pl.FP32], mom_wo__ssa_v0: pl.Tensor[[80, 80], pl.FP32], mom_w_gate__ssa_v0: pl.Tensor[[80, 400], pl.FP32], mom_w_up__ssa_v0: pl.Tensor[[80, 400], pl.FP32], mom_w_down__ssa_v0: pl.Tensor[[400, 80], pl.FP32], grad_wq__ssa_v0: pl.Tensor[[80, 80], pl.FP32], grad_wk__ssa_v0: pl.Tensor[[80, 80], pl.FP32], grad_wv__ssa_v0: pl.Tensor[[80, 80], pl.FP32], grad_wo__ssa_v0: pl.Tensor[[80, 80], pl.FP32], grad_w_gate__ssa_v0: pl.Tensor[[80, 400], pl.FP32], grad_w_up__ssa_v0: pl.Tensor[[80, 400], pl.FP32], grad_w_down__ssa_v0: pl.Tensor[[400, 80], pl.FP32], out__ssa_v0: pl.Tensor[[1, 4, 80], pl.BF16], loss_out__ssa_v0: pl.Tensor[[1], pl.FP32]) -> tuple[pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 400], pl.FP32], pl.Tensor[[80, 400], pl.FP32], pl.Tensor[[400, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 80], pl.FP32], pl.Tensor[[80, 400], pl.FP32], pl.Tensor[[80, 400], pl.FP32], pl.Tensor[[400, 80], pl.FP32], pl.Tensor[[1, 4, 80], pl.BF16], pl.Tensor[[1], pl.FP32]]:
        ...
        with pl.auto_incore():
            ...
            for b__idx_v0, (btrans_scratch__iter_v1, loss_acc__iter_v2, out__iter_v1) in pl.parallel(1, init_values=(btrans_scratch__ssa_v0, loss_acc__ssa_v1, out__ssa_v0), chunk=4):
                for p0_idx__idx_v0, (btrans_scratch__iter_v3, loss_acc__iter_v4, out__iter_v3) in pl.range(tok_blocks__ssa_v0, init_values=(btrans_scratch__iter_v1, loss_acc__iter_v2, out__iter_v1)):
                    ...
                    for kb__idx_v0, (sq_sum__iter_v2,) in pl.range(20, init_values=(sq_sum__ssa_v1,)):
                        ...
                        x_chunk__ssa_v0: pl.Tensor[[2, 4], pl.FP32] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(hidden_states__ssa_v0, [1, 2, 4], [b__idx_v0, p0__ssa_v0, k0__ssa_v0]), target_type=pl.FP32, mode='round'), [2, 4])
                        sq_sum__ssa_v4: pl.Tensor[[2, 1], pl.FP32] = pl.tensor.add(sq_sum__iter_v2, pl.tensor.row_sum(pl.tensor.mul(x_chunk__ssa_v0, x_chunk__ssa_v0)))
                        sq_sum__rv_v3: pl.Tensor[[2, 1], pl.FP32] = pl.yield_(sq_sum__ssa_v4)
                    inv_rms__ssa_v0: pl.Tensor[[2, 1], pl.FP32] = pl.tensor.rsqrt(pl.tensor.adds(pl.tensor.muls(sq_sum__rv_v3, 0.0125), 1e-06))
                    ...
                    for kb__idx_v0_1, (normed_tile__iter_v1,) in pl.range(20, init_values=(normed_tile__ssa_v0,)):
                        ...
                        x_chunk__ssa_v1: pl.Tensor[[2, 4], pl.FP32] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(hidden_states__ssa_v0, [1, 2, 4], [b__idx_v0, p0__ssa_v0, k0__ssa_v1]), target_type=pl.FP32, mode='round'), [2, 4])
                        gamma__ssa_v0: pl.Tensor[[1, 4], pl.FP32] = pl.tensor.slice(input_rms_weight__ssa_v0, [1, 4], [0, k0__ssa_v1])
                        normed__ssa_v0: pl.Tensor[[2, 4], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk__ssa_v1, inv_rms__ssa_v0), gamma__ssa_v0)
                        normed_tile__ssa_v3: pl.Tensor[[2, 80], pl.BF16] = pl.tensor.assemble(normed_tile__iter_v1, pl.tensor.cast(normed__ssa_v0, target_type=pl.BF16, mode='round'), [0, k0__ssa_v1])
                    ...
                    for ob__idx_v0, (k_proj_tile__iter_v1, q_proj_tile__iter_v1, v_proj_tile__iter_v1) in pl.range(10, init_values=(k_proj_tile__ssa_v0, q_proj_tile__ssa_v0, v_proj_tile__ssa_v0)):
                        ...
                        for kb__idx_v0_2, (k_acc__iter_v2, q_acc__iter_v2, v_acc__iter_v2) in pl.range(20, init_values=(k_acc__ssa_v1, q_acc__ssa_v1, v_acc__ssa_v1)):
                            ...
                            n_chunk__ssa_v0: pl.Tensor[[2, 4], pl.BF16] = pl.tensor.cast(pl.tensor.slice(normed_tile__rv_v2, [2, 4], [0, k0__ssa_v2]), target_type=pl.BF16, mode='round')
                            ...
                            q_acc__ssa_v4: pl.Tensor[[2, 8], pl.FP32] = pl.tensor.add(q_acc__iter_v2, pl.tensor.matmul(n_chunk__ssa_v0, wq_c__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False))
                            k_acc__ssa_v4: pl.Tensor[[2, 8], pl.FP32] = pl.tensor.add(k_acc__iter_v2, pl.tensor.matmul(n_chunk__ssa_v0, wk_c__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False))
                            v_acc__ssa_v4: pl.Tensor[[2, 8], pl.FP32] = pl.tensor.add(v_acc__iter_v2, pl.tensor.matmul(n_chunk__ssa_v0, wv_c__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False))
                            k_acc__rv_v3, q_acc__rv_v3, v_acc__rv_v3 = pl.yield_(k_acc__ssa_v4, q_acc__ssa_v4, v_acc__ssa_v4)
                        q_proj_tile__ssa_v3: pl.Tensor[[2, 80], pl.BF16] = pl.tensor.assemble(q_proj_tile__iter_v1, pl.tensor.cast(q_acc__rv_v3, target_type=pl.BF16, mode='round'), [0, q0__ssa_v0])
                        k_proj_tile__ssa_v3: pl.Tensor[[2, 80], pl.BF16] = pl.tensor.assemble(k_proj_tile__iter_v1, pl.tensor.cast(k_acc__rv_v3, target_type=pl.BF16, mode='round'), [0, q0__ssa_v0])
                        v_proj_tile__ssa_v3: pl.Tensor[[2, 80], pl.BF16] = pl.tensor.assemble(v_proj_tile__iter_v1, pl.tensor.cast(v_acc__rv_v3, target_type=pl.BF16, mode='round'), [0, q0__ssa_v0])
                    ...
                    for kb__idx_v0_3, (btrans_scratch__iter_v5, scores__iter_v2) in pl.range(20, init_values=(btrans_scratch__iter_v3, scores__ssa_v1)):
                        ...
                        q_c__ssa_v0: pl.Tensor[[2, 4], pl.FP32] = pl.tensor.cast(pl.tensor.slice(q_proj_tile__rv_v2, [2, 4], [0, k0__ssa_v3]), target_type=pl.FP32, mode='round')
                        k_c__ssa_v0: pl.Tensor[[2, 4], pl.FP32] = pl.tensor.cast(pl.tensor.slice(k_proj_tile__rv_v2, [2, 4], [0, k0__ssa_v3]), target_type=pl.FP32, mode='round')
                        ...
                        scores__ssa_v4: pl.Tensor[[2, 2], pl.FP32] = pl.tensor.add(scores__iter_v2, pl.tensor.matmul(q_c__ssa_v0, k_c_t__ssa_v0, a_trans=False, b_trans=True, c_matrix_nz=False, out_dtype=pl.FP32))
                    ...
                    attn_w__ssa_v0: pl.Tensor[[2, 2], pl.FP32] = pl.tensor.row_expand_mul(scores_exp__ssa_v0, pl.tensor.recip(scores_sum__ssa_v0))
                    ...
                    for ob__idx_v0_1, (context_tile__iter_v1,) in pl.range(10, init_values=(context_tile__ssa_v0,)):
                        ...
                        v_c__ssa_v0: pl.Tensor[[2, 8], pl.FP32] = pl.tensor.cast(pl.tensor.slice(v_proj_tile__rv_v2, [2, 8], [0, o0__ssa_v0]), target_type=pl.FP32, mode='round')
                        ...
                        ctx_acc__ssa_v2: pl.Tensor[[2, 8], pl.FP32] = pl.tensor.add(ctx_acc__ssa_v1, pl.tensor.matmul(attn_w__ssa_v0, v_c__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                        context_tile__ssa_v3: pl.Tensor[[2, 80], pl.BF16] = pl.tensor.assemble(context_tile__iter_v1, pl.tensor.cast(ctx_acc__ssa_v2, target_type=pl.BF16, mode='round'), [0, o0__ssa_v0])
                    ...
                    for ob__idx_v0_2, (resid1_tile__iter_v1,) in pl.range(10, init_values=(resid1_tile__ssa_v0,)):
                        ...
                        for kb__idx_v0_4, (o_acc__iter_v2,) in pl.range(20, init_values=(o_acc__ssa_v1,)):
                            ...
                            o_acc__ssa_v4: pl.Tensor[[2, 8], pl.FP32] = pl.tensor.add(o_acc__iter_v2, pl.tensor.matmul(ctx_chunk__ssa_v0, wo_c__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                            o_acc__rv_v3: pl.Tensor[[2, 8], pl.FP32] = pl.yield_(o_acc__ssa_v4)
                        resid__ssa_v0: pl.Tensor[[2, 8], pl.FP32] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(hidden_states__ssa_v0, [1, 2, 8], [b__idx_v0, p0__ssa_v0, o0__ssa_v1]), target_type=pl.FP32, mode='round'), [2, 8])
                        resid1_tile__ssa_v3: pl.Tensor[[2, 80], pl.FP32] = pl.tensor.assemble(resid1_tile__iter_v1, pl.tensor.add(o_acc__rv_v3, resid__ssa_v0), [0, o0__ssa_v1])
                    ...
                    for kb__idx_v0_5, (sq_sum2__iter_v2,) in pl.range(20, init_values=(sq_sum2__ssa_v1,)):
                        ...
                        sq_sum2__ssa_v4: pl.Tensor[[2, 1], pl.FP32] = pl.tensor.add(sq_sum2__iter_v2, pl.tensor.row_sum(pl.tensor.mul(x_chunk__ssa_v2, x_chunk__ssa_v2)))
                        sq_sum2__rv_v3: pl.Tensor[[2, 1], pl.FP32] = pl.yield_(sq_sum2__ssa_v4)
                    inv_rms2__ssa_v0: pl.Tensor[[2, 1], pl.FP32] = pl.tensor.rsqrt(pl.tensor.adds(pl.tensor.muls(sq_sum2__rv_v3, 0.0125), 1e-06))
                    ...
                    for kb__idx_v0_6, (post_norm_tile__iter_v1,) in pl.range(20, init_values=(post_norm_tile__ssa_v0,)):
                        ...
                        normed__ssa_v1: pl.Tensor[[2, 4], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk__ssa_v3, inv_rms2__ssa_v0), gamma__ssa_v1)
                        post_norm_tile__ssa_v3: pl.Tensor[[2, 80], pl.BF16] = pl.tensor.assemble(post_norm_tile__iter_v1, pl.tensor.cast(normed__ssa_v1, target_type=pl.BF16, mode='round'), [0, k0__ssa_v6])
                    ...
                    for mb__idx_v0, (down_tile__iter_v2,) in pl.range(25, init_values=(down_tile__ssa_v1,)):
                        ...
                        for kb__idx_v0_7, (gate_acc__iter_v2, up_acc__iter_v2) in pl.range(20, init_values=(gate_acc__ssa_v1, up_acc__ssa_v1)):
                            ...
                            gate_acc__ssa_v4: pl.Tensor[[2, 16], pl.FP32] = pl.tensor.add(gate_acc__iter_v2, pl.tensor.matmul(post_chunk__ssa_v0, wg__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                            up_acc__ssa_v4: pl.Tensor[[2, 16], pl.FP32] = pl.tensor.add(up_acc__iter_v2, pl.tensor.matmul(post_chunk__ssa_v0, wu__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                            gate_acc__rv_v3, up_acc__rv_v3 = pl.yield_(gate_acc__ssa_v4, up_acc__ssa_v4)
                        sigmoid_chunk__ssa_v0: pl.Tensor[[2, 16], pl.FP32] = pl.tensor.recip(pl.tensor.adds(pl.tensor.exp(pl.tensor.neg(gate_acc__rv_v3)), 1.0))
                        mlp_chunk__ssa_v0: pl.Tensor[[2, 16], pl.BF16] = pl.tensor.cast(pl.tensor.mul(pl.tensor.mul(gate_acc__rv_v3, sigmoid_chunk__ssa_v0), up_acc__rv_v3), target_type=pl.BF16, mode='round')
                        for ob__idx_v0_3, (down_tile__iter_v4,) in pl.range(10, init_values=(down_tile__iter_v2,)):
                            ...
                            down_part__ssa_v0: pl.Tensor[[2, 8], pl.FP32] = pl.tensor.add(down_prev__ssa_v0, pl.tensor.matmul(mlp_chunk__ssa_v0, wd__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                    ...
                    for ob__idx_v0_4, (out__iter_v5, out_tile__iter_v1) in pl.range(10, init_values=(out__iter_v3, out_tile__ssa_v0)):
                        ...
                        out_chunk__ssa_v0: pl.Tensor[[2, 8], pl.FP32] = pl.tensor.add(pl.tensor.slice(down_tile__rv_v3, [2, 8], [0, o0__ssa_v3]), pl.tensor.slice(resid1_tile__rv_v2, [2, 8], [0, o0__ssa_v3]))
                        out_tile__ssa_v3: pl.Tensor[[2, 80], pl.FP32] = pl.tensor.assemble(out_tile__iter_v1, out_chunk__ssa_v0, [0, o0__ssa_v3])
                        out__ssa_v7: pl.Tensor[[1, 4, 80], pl.BF16] = pl.tensor.assemble(out__iter_v5, pl.tensor.reshape(pl.tensor.cast(out_chunk__ssa_v0, target_type=pl.BF16, mode='round'), [1, 2, 8]), [b__idx_v0, p0__ssa_v0, o0__ssa_v3])
                        out__rv_v6, out_tile__rv_v2 = pl.yield_(out__ssa_v7, out_tile__ssa_v3)
                    tgt_tile__ssa_v0: pl.Tensor[[2, 80], pl.FP32] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(target_states__ssa_v0, [1, 2, 80], [b__idx_v0, p0__ssa_v0, 0]), target_type=pl.FP32, mode='round'), [2, 80])
                    ...
                    loss_acc__ssa_v6: pl.Tensor[[2, 1], pl.FP32] = pl.tensor.assemble(loss_acc__iter_v4, pl.tensor.add(loss_prev__ssa_v0, sq_row__ssa_v0), [0, 0])
                    ...
                    for mb__idx_v0_1, (d_post_norm__iter_v2,) in pl.range(25, init_values=(d_post_norm__ssa_v1,)):
                        ...
                        for kb__idx_v0_8, (gate_r__iter_v2, up_r__iter_v2) in pl.range(20, init_values=(gate_r__ssa_v1, up_r__ssa_v1)):
                            ...
                            gate_r__ssa_v4: pl.Tensor[[2, 16], pl.FP32] = pl.tensor.add(gate_r__iter_v2, pl.tensor.matmul(post_c__ssa_v0, wg_c__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                            up_r__ssa_v4: pl.Tensor[[2, 16], pl.FP32] = pl.tensor.add(up_r__iter_v2, pl.tensor.matmul(post_c__ssa_v0, wu_c__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                            gate_r__rv_v3, up_r__rv_v3 = pl.yield_(gate_r__ssa_v4, up_r__ssa_v4)
                        sig_r__ssa_v0: pl.Tensor[[2, 16], pl.FP32] = pl.tensor.recip(pl.tensor.adds(pl.tensor.exp(pl.tensor.neg(gate_r__rv_v3)), 1.0))
                        ...
                        for ob__idx_v0_5, (d_mlp__iter_v2,) in pl.range(10, init_values=(d_mlp__ssa_v1,)):
                            ...
                            dd_c__ssa_v0: pl.Tensor[[2, 8], pl.BF16] = pl.tensor.cast(pl.tensor.slice(d_down__ssa_v0, [2, 8], [0, o0__ssa_v4]), target_type=pl.BF16, mode='round')
                            wd_c__ssa_v0: pl.Tensor[[16, 8], pl.BF16] = pl.tensor.slice(w_down__ssa_v0, [16, 8], [m0__ssa_v1, o0__ssa_v4])
                            d_mlp__ssa_v4: pl.Tensor[[2, 16], pl.FP32] = pl.tensor.add(d_mlp__iter_v2, pl.tensor.matmul(dd_c__ssa_v0, wd_c__ssa_v0, a_trans=False, b_trans=True, c_matrix_nz=False, out_dtype=pl.FP32))
                            d_mlp__rv_v3: pl.Tensor[[2, 16], pl.FP32] = pl.yield_(d_mlp__ssa_v4)
                        one_m_sig__ssa_v0: pl.Tensor[[2, 16], pl.FP32] = pl.tensor.adds(pl.tensor.muls(sig_r__ssa_v0, -1.0), 1.0)
                        silu_deriv__ssa_v0: pl.Tensor[[2, 16], pl.FP32] = pl.tensor.mul(sig_r__ssa_v0, pl.tensor.adds(pl.tensor.mul(gate_r__rv_v3, one_m_sig__ssa_v0), 1.0))
                        d_gate_bf16__ssa_v0: pl.Tensor[[2, 16], pl.BF16] = pl.tensor.cast(pl.tensor.mul(pl.tensor.mul(d_mlp__rv_v3, up_r__rv_v3), silu_deriv__ssa_v0), target_type=pl.BF16, mode='round')
                        d_up_bf16__ssa_v0: pl.Tensor[[2, 16], pl.BF16] = pl.tensor.cast(pl.tensor.mul(d_mlp__rv_v3, pl.tensor.mul(gate_r__rv_v3, sig_r__ssa_v0)), target_type=pl.BF16, mode='round')
                        for kb__idx_v0_9, (d_post_norm__iter_v4,) in pl.range(20, init_values=(d_post_norm__iter_v2,)):
                            ...
                            dpn_tmp__ssa_v0: pl.Tensor[[2, 4], pl.FP32] = pl.tensor.add(dpn_old__ssa_v0, pl.tensor.matmul(d_gate_bf16__ssa_v0, wg_c__ssa_v1, a_trans=False, b_trans=True, c_matrix_nz=False, out_dtype=pl.FP32))
                            dpn_new__ssa_v0: pl.Tensor[[2, 4], pl.FP32] = pl.tensor.add(dpn_tmp__ssa_v0, pl.tensor.matmul(d_up_bf16__ssa_v0, wu_c__ssa_v1, a_trans=False, b_trans=True, c_matrix_nz=False, out_dtype=pl.FP32))
                    ...
                    for kb__idx_v0_10, (bwd_energy__iter_v2,) in pl.range(20, init_values=(bwd_energy__ssa_v1,)):
                        ...
                        q_c__ssa_v1: pl.Tensor[[2, 4], pl.FP32] = pl.tensor.cast(pl.tensor.slice(q_proj_tile__rv_v2, [2, 4], [0, k0__ssa_v10]), target_type=pl.FP32, mode='round')
                        k_c__ssa_v1: pl.Tensor[[2, 4], pl.FP32] = pl.tensor.cast(pl.tensor.slice(k_proj_tile__rv_v2, [2, 4], [0, k0__ssa_v10]), target_type=pl.FP32, mode='round')
                        v_bwd__ssa_v0: pl.Tensor[[2, 4], pl.FP32] = pl.tensor.cast(pl.tensor.slice(v_proj_tile__rv_v2, [2, 4], [0, k0__ssa_v10]), target_type=pl.FP32, mode='round')
                        contrib__ssa_v0: pl.Tensor[[2, 1], pl.FP32] = pl.tensor.row_sum(pl.tensor.mul(dr_c__ssa_v0, pl.tensor.add(pl.tensor.add(q_c__ssa_v1, k_c__ssa_v1), v_bwd__ssa_v0)))
                    ...
                    bwd_energy__ssa_v5: pl.Tensor[[2, 1], pl.FP32] = pl.tensor.add(bwd_energy__rv_v3, pl.tensor.row_sum(attn_w__ssa_v0))
                ...
                btrans_scratch__rv_v2, loss_acc__rv_v3, out__rv_v2 = pl.yield_(btrans_scratch__rv_v4, loss_acc__rv_v5, out__rv_v4)
            proxy_mlp__ssa_v0: pl.Tensor[[2, 16], pl.BF16] = pl.tensor.cast(pl.tensor.slice(w_up__ssa_v0, [2, 16], [0, 0]), target_type=pl.BF16, mode='round')
            ...
            for qb__idx_v0, (grad_w_down__iter_v2, mom_w_down__iter_v1, muon_scratch__iter_v1, proxy_scratch__iter_v2) in pl.range(10, init_values=(grad_w_down__ssa_v1, mom_w_down__ssa_v0, muon_scratch__ssa_v0, proxy_scratch__ssa_v1)):
                ...
                proxy_go__ssa_v0: pl.Tensor[[2, 8], pl.BF16] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(target_states__ssa_v0, [1, 2, 8], [0, 0, q0__ssa_v1]), target_type=pl.BF16, mode='round'), [2, 8])
                ...
                mom_down_new__ssa_v0: pl.Tensor[[16, 8], pl.FP32] = pl.tensor.add(pl.tensor.muls(mom_down_prev__ssa_v0, 0.95), pl.tensor.muls(grad_down_raw__ssa_v0, 0.05))
                muon_down__ssa_v0: pl.Tensor[[16, 8], pl.FP32] = mom_down_new__ssa_v0
                muon_scratch__ssa_v3: pl.Tensor[[16, 16], pl.BF16] = pl.tensor.assemble(muon_scratch__iter_v1, pl.tensor.cast(muon_down__ssa_v0, target_type=pl.BF16, mode='round'), [0, 0])
                for ___idx_v0, (muon_down__iter_v1,) in pl.range(2, init_values=(muon_down__ssa_v0,)):
                    ...
                    for tb__idx_v0, (gram__iter_v2,) in pl.range(8, init_values=(gram__ssa_v1,)):
                        ...
                        gram__ssa_v4: pl.Tensor[[8, 8], pl.FP32] = pl.tensor.add(gram__iter_v2, pl.tensor.matmul(m_blk_t__ssa_v0, m_blk__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                        gram__rv_v3: pl.Tensor[[8, 8], pl.FP32] = pl.yield_(gram__ssa_v4)
                    muon_down__ssa_v3: pl.Tensor[[16, 8], pl.FP32] = pl.tensor.add(pl.tensor.muls(muon_down__iter_v1, 1.5), pl.tensor.muls(pl.tensor.matmul(muon_down__iter_v1, gram__rv_v3, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32), -0.5))
                    muon_down__rv_v2: pl.Tensor[[16, 8], pl.FP32] = pl.yield_(muon_down__ssa_v3)
                grad_w_down__ssa_v4: pl.Tensor[[400, 80], pl.FP32] = pl.tensor.assemble(grad_w_down__iter_v2, pl.tensor.muls(muon_down__rv_v2, -0.0002), [0, q0__ssa_v1])
            ...
            proxy_ctx__ssa_v0: pl.Tensor[[2, 4], pl.BF16] = pl.tensor.cast(pl.tensor.slice(wq__ssa_v0, [2, 4], [0, 0]), target_type=pl.BF16, mode='round')
            proxy_n__ssa_v0: pl.Tensor[[2, 4], pl.BF16] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(hidden_states__ssa_v0, [1, 2, 4], [0, 0, 0]), target_type=pl.BF16, mode='round'), [2, 4])
            ...
            for qb__idx_v0_1, (grad_wk__iter_v2, grad_wo__iter_v2, grad_wq__iter_v2, grad_wv__iter_v2, mom_wk__iter_v1, mom_wo__iter_v1, mom_wq__iter_v1, mom_wv__iter_v1, muon_scratch__iter_v4, proxy_scratch__iter_v7) in pl.range(10, init_values=(grad_wk__ssa_v1, grad_wo__ssa_v1, grad_wq__ssa_v1, grad_wv__ssa_v1, mom_wk__ssa_v0, mom_wo__ssa_v0, mom_wq__ssa_v0, mom_wv__ssa_v0, muon_scratch__rv_v2, proxy_scratch__ssa_v6)):
                q0__ssa_v2: pl.Scalar[pl.INDEX] = qb__idx_v0_1 * 8
                proxy_tgt__ssa_v0: pl.Tensor[[2, 8], pl.BF16] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(target_states__ssa_v0, [1, 2, 8], [0, 0, q0__ssa_v2]), target_type=pl.BF16, mode='round'), [2, 8])
                ...
                mom_wo_new__ssa_v0: pl.Tensor[[4, 8], pl.FP32] = pl.tensor.add(pl.tensor.muls(mom_wo_prev__ssa_v0, 0.95), pl.tensor.muls(grad_wo_raw__ssa_v0, 0.05))
                muon_wo__ssa_v0: pl.Tensor[[4, 8], pl.FP32] = mom_wo_new__ssa_v0
                muon_scratch__ssa_v6: pl.Tensor[[16, 16], pl.BF16] = pl.tensor.assemble(muon_scratch__iter_v4, pl.tensor.cast(muon_wo__ssa_v0, target_type=pl.BF16, mode='round'), [0, 0])
                for ___idx_v0_1, (muon_wo__iter_v1,) in pl.range(2, init_values=(muon_wo__ssa_v0,)):
                    ...
                    for tb__idx_v0_1, (gram__iter_v7,) in pl.range(2, init_values=(gram__ssa_v6,)):
                        t0__ssa_v1: pl.Scalar[pl.INDEX] = tb__idx_v0_1 * 2
                        ...
                        gram__ssa_v9: pl.Tensor[[8, 8], pl.FP32] = pl.tensor.add(gram__iter_v7, pl.tensor.matmul(m_blk_t__ssa_v1, m_blk__ssa_v1, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                        gram__rv_v8: pl.Tensor[[8, 8], pl.FP32] = pl.yield_(gram__ssa_v9)
                    muon_wo__ssa_v3: pl.Tensor[[4, 8], pl.FP32] = pl.tensor.add(pl.tensor.muls(muon_wo__iter_v1, 1.5), pl.tensor.muls(pl.tensor.matmul(muon_wo__iter_v1, gram__rv_v8, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32), -0.5))
                    muon_wo__rv_v2: pl.Tensor[[4, 8], pl.FP32] = pl.yield_(muon_wo__ssa_v3)
                grad_wo__ssa_v4: pl.Tensor[[80, 80], pl.FP32] = pl.tensor.assemble(grad_wo__iter_v2, pl.tensor.muls(muon_wo__rv_v2, -0.0002), [0, q0__ssa_v2])
                ...
                mom_wq_new__ssa_v0: pl.Tensor[[4, 8], pl.FP32] = pl.tensor.add(pl.tensor.muls(mom_wq_prev__ssa_v0, 0.95), pl.tensor.muls(grad_wq_raw__ssa_v0, 0.05))
                muon_wq__ssa_v0: pl.Tensor[[4, 8], pl.FP32] = mom_wq_new__ssa_v0
                muon_scratch__ssa_v7: pl.Tensor[[16, 16], pl.BF16] = pl.tensor.assemble(muon_scratch__ssa_v6, pl.tensor.cast(muon_wq__ssa_v0, target_type=pl.BF16, mode='round'), [0, 0])
                for ___idx_v0_2, (muon_wq__iter_v1,) in pl.range(2, init_values=(muon_wq__ssa_v0,)):
                    ...
                    for tb__idx_v0_2, (gram__iter_v12,) in pl.range(2, init_values=(gram__ssa_v11,)):
                        t0__ssa_v2: pl.Scalar[pl.INDEX] = tb__idx_v0_2 * 2
                        ...
                        gram__ssa_v14: pl.Tensor[[8, 8], pl.FP32] = pl.tensor.add(gram__iter_v12, pl.tensor.matmul(m_blk_t__ssa_v2, m_blk__ssa_v2, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                        gram__rv_v13: pl.Tensor[[8, 8], pl.FP32] = pl.yield_(gram__ssa_v14)
                    muon_wq__ssa_v3: pl.Tensor[[4, 8], pl.FP32] = pl.tensor.add(pl.tensor.muls(muon_wq__iter_v1, 1.5), pl.tensor.muls(pl.tensor.matmul(muon_wq__iter_v1, gram__rv_v13, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32), -0.5))
                    muon_wq__rv_v2: pl.Tensor[[4, 8], pl.FP32] = pl.yield_(muon_wq__ssa_v3)
                grad_wq__ssa_v4: pl.Tensor[[80, 80], pl.FP32] = pl.tensor.assemble(grad_wq__iter_v2, pl.tensor.muls(muon_wq__rv_v2, -0.0002), [0, q0__ssa_v2])
                ...
                mom_wk_new__ssa_v0: pl.Tensor[[4, 8], pl.FP32] = pl.tensor.add(pl.tensor.muls(mom_wk_prev__ssa_v0, 0.95), pl.tensor.muls(grad_wk_raw__ssa_v0, 0.05))
                muon_wk__ssa_v0: pl.Tensor[[4, 8], pl.FP32] = mom_wk_new__ssa_v0
                muon_scratch__ssa_v8: pl.Tensor[[16, 16], pl.BF16] = pl.tensor.assemble(muon_scratch__ssa_v7, pl.tensor.cast(muon_wk__ssa_v0, target_type=pl.BF16, mode='round'), [0, 0])
                for ___idx_v0_3, (muon_wk__iter_v1,) in pl.range(2, init_values=(muon_wk__ssa_v0,)):
                    ...
                    for tb__idx_v0_3, (gram__iter_v17,) in pl.range(2, init_values=(gram__ssa_v16,)):
                        t0__ssa_v3: pl.Scalar[pl.INDEX] = tb__idx_v0_3 * 2
                        ...
                        gram__ssa_v19: pl.Tensor[[8, 8], pl.FP32] = pl.tensor.add(gram__iter_v17, pl.tensor.matmul(m_blk_t__ssa_v3, m_blk__ssa_v3, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                        gram__rv_v18: pl.Tensor[[8, 8], pl.FP32] = pl.yield_(gram__ssa_v19)
                    muon_wk__ssa_v3: pl.Tensor[[4, 8], pl.FP32] = pl.tensor.add(pl.tensor.muls(muon_wk__iter_v1, 1.5), pl.tensor.muls(pl.tensor.matmul(muon_wk__iter_v1, gram__rv_v18, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32), -0.5))
                    muon_wk__rv_v2: pl.Tensor[[4, 8], pl.FP32] = pl.yield_(muon_wk__ssa_v3)
                grad_wk__ssa_v4: pl.Tensor[[80, 80], pl.FP32] = pl.tensor.assemble(grad_wk__iter_v2, pl.tensor.muls(muon_wk__rv_v2, -0.0002), [0, q0__ssa_v2])
                ...
                mom_wv_new__ssa_v0: pl.Tensor[[4, 8], pl.FP32] = pl.tensor.add(pl.tensor.muls(mom_wv_prev__ssa_v0, 0.95), pl.tensor.muls(grad_wv_raw__ssa_v0, 0.05))
                muon_wv__ssa_v0: pl.Tensor[[4, 8], pl.FP32] = mom_wv_new__ssa_v0
                muon_scratch__ssa_v9: pl.Tensor[[16, 16], pl.BF16] = pl.tensor.assemble(muon_scratch__ssa_v8, pl.tensor.cast(muon_wv__ssa_v0, target_type=pl.BF16, mode='round'), [0, 0])
                for ___idx_v0_4, (muon_wv__iter_v1,) in pl.range(2, init_values=(muon_wv__ssa_v0,)):
                    ...
                    for tb__idx_v0_4, (gram__iter_v22,) in pl.range(2, init_values=(gram__ssa_v21,)):
                        t0__ssa_v4: pl.Scalar[pl.INDEX] = tb__idx_v0_4 * 2
                        ...
                        gram__ssa_v24: pl.Tensor[[8, 8], pl.FP32] = pl.tensor.add(gram__iter_v22, pl.tensor.matmul(m_blk_t__ssa_v4, m_blk__ssa_v4, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                        gram__rv_v23: pl.Tensor[[8, 8], pl.FP32] = pl.yield_(gram__ssa_v24)
                    muon_wv__ssa_v3: pl.Tensor[[4, 8], pl.FP32] = pl.tensor.add(pl.tensor.muls(muon_wv__iter_v1, 1.5), pl.tensor.muls(pl.tensor.matmul(muon_wv__iter_v1, gram__rv_v23, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32), -0.5))
                    muon_wv__rv_v2: pl.Tensor[[4, 8], pl.FP32] = pl.yield_(muon_wv__ssa_v3)
                grad_wv__ssa_v4: pl.Tensor[[80, 80], pl.FP32] = pl.tensor.assemble(grad_wv__iter_v2, pl.tensor.muls(muon_wv__rv_v2, -0.0002), [0, q0__ssa_v2])
            ...
            proxy_post__ssa_v0: pl.Tensor[[2, 4], pl.BF16] = pl.tensor.reshape(pl.tensor.cast(pl.tensor.slice(hidden_states__ssa_v0, [1, 2, 4], [0, 0, 4]), target_type=pl.BF16, mode='round'), [2, 4])
            ...
            for mb__idx_v0_2, (grad_w_gate__iter_v2, grad_w_up__iter_v2, mom_w_gate__iter_v1, mom_w_up__iter_v1, muon_scratch__iter_v10, proxy_scratch__iter_v11) in pl.range(25, init_values=(grad_w_gate__ssa_v1, grad_w_up__ssa_v1, mom_w_gate__ssa_v0, mom_w_up__ssa_v0, muon_scratch__rv_v5, proxy_scratch__ssa_v10)):
                m0__ssa_v2: pl.Scalar[pl.INDEX] = mb__idx_v0_2 * 16
                proxy_gg__ssa_v0: pl.Tensor[[2, 16], pl.BF16] = pl.tensor.cast(pl.tensor.slice(w_gate__ssa_v0, [2, 16], [0, m0__ssa_v2]), target_type=pl.BF16, mode='round')
                proxy_gu__ssa_v0: pl.Tensor[[2, 16], pl.BF16] = pl.tensor.cast(pl.tensor.slice(w_up__ssa_v0, [2, 16], [0, m0__ssa_v2]), target_type=pl.BF16, mode='round')
                ...
                mom_wg_new__ssa_v0: pl.Tensor[[4, 16], pl.FP32] = pl.tensor.add(pl.tensor.muls(mom_wg_prev__ssa_v0, 0.95), pl.tensor.muls(grad_wg_raw__ssa_v0, 0.05))
                mom_wu_new__ssa_v0: pl.Tensor[[4, 16], pl.FP32] = pl.tensor.add(pl.tensor.muls(mom_wu_prev__ssa_v0, 0.95), pl.tensor.muls(grad_wu_raw__ssa_v0, 0.05))
                muon_wg__ssa_v0: pl.Tensor[[4, 16], pl.FP32] = mom_wg_new__ssa_v0
                muon_scratch__ssa_v12: pl.Tensor[[16, 16], pl.BF16] = pl.tensor.assemble(muon_scratch__iter_v10, pl.tensor.cast(muon_wg__ssa_v0, target_type=pl.BF16, mode='round'), [0, 0])
                for ___idx_v0_5, (muon_wg__iter_v1,) in pl.range(2, init_values=(muon_wg__ssa_v0,)):
                    ...
                    for tb__idx_v0_5, (ns_acc_g__iter_v2,) in pl.range(2, init_values=(ns_acc_g__ssa_v1,)):
                        t0__ssa_v5: pl.Scalar[pl.INDEX] = tb__idx_v0_5 * 2
                        ...
                        ns_acc_g__ssa_v4: pl.Tensor[[4, 16], pl.FP32] = pl.tensor.add(ns_acc_g__iter_v2, pl.tensor.matmul(tmp_g_bf__ssa_v0, m_blk_g__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                        ns_acc_g__rv_v3: pl.Tensor[[4, 16], pl.FP32] = pl.yield_(ns_acc_g__ssa_v4)
                    muon_wg__ssa_v3: pl.Tensor[[4, 16], pl.FP32] = pl.tensor.add(pl.tensor.muls(muon_wg__iter_v1, 1.5), pl.tensor.muls(ns_acc_g__rv_v3, -0.5))
                    muon_wg__rv_v2: pl.Tensor[[4, 16], pl.FP32] = pl.yield_(muon_wg__ssa_v3)
                muon_wu__ssa_v0: pl.Tensor[[4, 16], pl.FP32] = mom_wu_new__ssa_v0
                muon_scratch__ssa_v13: pl.Tensor[[16, 16], pl.BF16] = pl.tensor.assemble(muon_scratch__ssa_v12, pl.tensor.cast(muon_wu__ssa_v0, target_type=pl.BF16, mode='round'), [0, 0])
                for ___idx_v0_6, (muon_wu__iter_v1,) in pl.range(2, init_values=(muon_wu__ssa_v0,)):
                    ...
                    for tb__idx_v0_6, (ns_acc_u__iter_v2,) in pl.range(2, init_values=(ns_acc_u__ssa_v1,)):
                        t0__ssa_v6: pl.Scalar[pl.INDEX] = tb__idx_v0_6 * 2
                        ...
                        ns_acc_u__ssa_v4: pl.Tensor[[4, 16], pl.FP32] = pl.tensor.add(ns_acc_u__iter_v2, pl.tensor.matmul(tmp_u_bf__ssa_v0, m_blk_u__ssa_v0, a_trans=False, b_trans=False, c_matrix_nz=False, out_dtype=pl.FP32))
                        ns_acc_u__rv_v3: pl.Tensor[[4, 16], pl.FP32] = pl.yield_(ns_acc_u__ssa_v4)
                    muon_wu__ssa_v3: pl.Tensor[[4, 16], pl.FP32] = pl.tensor.add(pl.tensor.muls(muon_wu__iter_v1, 1.5), pl.tensor.muls(ns_acc_u__rv_v3, -0.5))
                    muon_wu__rv_v2: pl.Tensor[[4, 16], pl.FP32] = pl.yield_(muon_wu__ssa_v3)
                grad_w_gate__ssa_v4: pl.Tensor[[80, 400], pl.FP32] = pl.tensor.assemble(grad_w_gate__iter_v2, pl.tensor.muls(muon_wg__rv_v2, -0.0002), [0, m0__ssa_v2])
                grad_w_up__ssa_v4: pl.Tensor[[80, 400], pl.FP32] = pl.tensor.assemble(grad_w_up__iter_v2, pl.tensor.muls(muon_wu__rv_v2, -0.0002), [0, m0__ssa_v2])
            ...
            loss_vec__ssa_v0: pl.Tensor[[1], pl.FP32] = pl.tensor.slice(loss_acc__rv_v3, [1], [0, 0])
            loss_out__ssa_v1: pl.Tensor[[1], pl.FP32] = pl.tensor.assemble(loss_out__ssa_v0, loss_vec__ssa_v0, [0])
        return grad_wq__rv_v3, grad_wk__rv_v3, grad_wv__rv_v3, grad_wo__rv_v3, grad_w_gate__rv_v3, grad_w_up__rv_v3, grad_w_down__rv_v3, mom_wq__rv_v2, mom_wk__rv_v2, mom_wv__rv_v2, mom_wo__rv_v2, mom_w_gate__rv_v2, mom_w_up__rv_v2, mom_w_down__rv_v2, out__rv_v2, loss_out__ssa_v1